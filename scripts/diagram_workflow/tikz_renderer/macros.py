...
\providecommand{\AngleMark}[4][]{\pic[draw=edu-diagram-angle,line width=0.9pt,angle radius=0.32cm,#1] {angle=#2--#3--#4};}
...
\providecommand{\EqualTick}[3][]{%
  \path[postaction={decorate},decoration={markings,mark=at position .5 with {\draw[diagram tick,#1] (0pt,-1.33pt) -- (0pt,1.33pt);}}] (#2) -- (#3);%
}
\providecommand{\DoubleEqualTick}[3][]{%
  \path[postaction={decorate},decoration={markings,mark=at position .46 with {\draw[diagram tick,#1] (0pt,-1.33pt) -- (0pt,1.33pt);},mark=at position .54 with {\draw[diagram tick,#1] (0pt,-1.33pt) -- (0pt,1.33pt);}}] (#2) -- (#3);%
}
\providecommand{\TripleEqualTick}[3][]{%
  \path[postaction={decorate},decoration={markings,mark=at position .43 with {\draw[diagram tick,#1] (0pt,-1.33pt) -- (0pt,1.33pt);},mark=at position .5 with {\draw[diagram tick,#1] (0pt,-1.33pt) -- (0pt,1.33pt);},mark=at position .57 with {\draw[diagram tick,#1] (0pt,-1.33pt) -- (0pt,1.33pt);}}] (#2) -- (#3);%
}
