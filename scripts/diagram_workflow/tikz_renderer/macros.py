...
\tikzset{
  ...
  diagram tick/.style={draw=edu-diagram-marker,line width=1.2pt,line cap=round},
...
\providecommand{\DiagramPointRadius}{0.073cm}
...
\providecommand{\AngleMark}[4][]{\pic[draw=edu-diagram-angle,line width=1.2pt,angle radius=0.48cm,#1] {angle=#2--#3--#4};}
\providecommand{\AngleLabel}[5][]{\pic["{#5}",draw=none,angle radius=0.64cm,#1] {angle=#2--#3--#4};}
\providecommand{\RightAngleMark}[4][]{\pic[draw=edu-diagram-marker,line width=1.2pt,angle radius=0.28cm,#1] {right angle=#2--#3--#4};}
