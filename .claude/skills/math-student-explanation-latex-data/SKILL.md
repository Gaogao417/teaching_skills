...
python math-assignment-latex/scripts/render_assignment.py \
  artifacts/<slug>/02-student-explanation.assignment.yaml \
  --out artifacts/<slug>/02-explanation.tex

python math-assignment-latex/scripts/check_latex.py artifacts/<slug>/02-explanation.tex

bash math-assignment-latex/scripts/compile_latex.sh artifacts/<slug>/02-explanation.tex
```
