...
```bash
python3 scripts/run_assignment_diagrams.py \
...
```bash
python3 scripts/run_assignment_diagrams.py <plan.yaml> --out <resolved.yaml> --max-workers 4
python3 scripts/run_assignment_diagrams.py <plan.yaml> --dry-run
```
