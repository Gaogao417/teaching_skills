...
def main() -> int:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "with an explicit --layout, repair non-monotonic question page seeds "
            "by clamping answer-block outliers back into the question region; "
    ...
    seed_corrections = report["seed_corrections"]
    print(
