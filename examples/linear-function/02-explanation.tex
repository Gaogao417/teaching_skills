...
\begin{eduVariationTraining}{变式 1}
...
\begin{eduVariationTraining}{变式 2}
已知一次函数 $y=kx+b$ 经过点 $(1,3)$，且与 $y$ 轴交于点 $(0,-3)$。
\begin{enumerate}[label=(\arabic*)]
  \item 求这个一次函数的解析式；
  \item 求它与 $x$ 轴的交点坐标，并计算与两坐标轴围成的三角形面积。
\end{enumerate}
...
\begin{eduVariationTraining}{变式 3}
已知一次函数图像与 $x$ 轴交于 $(4,0)$，与 $y$ 轴交于 $(0,-2)$。
\begin{enumerate}[label=(\arabic*)]
  \item 求这个一次函数的解析式；
  \item 判断点 $P(2,-1)$ 是否在这个函数图像上；
  \item 求该图像与两坐标轴围成的三角形面积。
\end{enumerate}
