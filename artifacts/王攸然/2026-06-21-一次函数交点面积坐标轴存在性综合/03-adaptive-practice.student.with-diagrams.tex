...
\par\noindent (3) 在坐标轴上，是否存在一点 $P$，使得 $S_{\triangle AOP}=2S_{\triangle BCP}$？若存在，直接写出点 $P$ 的坐标；若不存在，说明理由。
  ...
  \input{\detokenize{build/diagram/jobs/practice-student-p1-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[70mm]
\end{problem}
...
\par\noindent (3) 点 $P$ 在 $x$ 轴上，若 $S_{\triangle AOP}=S_{\triangle PAB}$，求点 $P$ 的坐标。
  ...
  \input{\detokenize{build/diagram/jobs/practice-student-p2-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[72mm]
\end{problem}
...
\par\noindent (3) 点 $P$ 在反比例函数第四象限分支上，且在点 $A$ 的右侧。若 $S_{\triangle PAB}=3$，求点 $P$ 的坐标。
  ...
  \input{\detokenize{build/diagram/jobs/practice-student-p3-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[76mm]
\end{problem}
