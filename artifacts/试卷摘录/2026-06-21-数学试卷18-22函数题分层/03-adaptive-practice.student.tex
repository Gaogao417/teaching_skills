...
\begin{problem}[points=6]
  ...
  \input{\detokenize{diagrams/line-cross-a.fragment.tex}}
...
\begin{problem}[points=6]
  ...
  \input{\detokenize{diagrams/two-lines-x3.fragment.tex}}
  \end{answerareawithdiagramtikz}
\end{problem}
...
\begin{question}[points=4]
  ...
  \input{\detokenize{diagrams/line-positive-basic.fragment.tex}}
  \end{diagramcoltikz}
\end{question}
...
\end{enumerate}
  ...
  \input{\detokenize{diagrams/axes-y1-y2.fragment.tex}}
  \end{answerareawithdiagramtikz}
\end{problem}
...
\end{enumerate}
  ...
  \input{\detokenize{diagrams/speed-cars.fragment.tex}}
  \end{answerareawithdiagramtikz}
\end{problem}
...
\end{enumerate}
  ...
  \input{\detokenize{diagrams/inverse-ab.fragment.tex}}
  \end{answerareawithdiagramtikz}
\end{problem}
...
\end{enumerate}
  ...
  \input{\detokenize{diagrams/line-hyperbola.fragment.tex}}
  \end{answerareawithdiagramtikz}
\end{problem}
...
\end{enumerate}
  ...
  \input{\detokenize{diagrams/slide-hyperbola.fragment.tex}}
  \end{answerareawithdiagramtikz}
\end{problem}
