...
\begin{problem}[points=8]
  ...
  \begin{minipage}[t]{\dimexpr\linewidth-60mm-6mm\relax}
    \vspace{0pt}
    在 $\triangle ABC$ 中，点 $D$ 在边 $BC$ 上，点 $E$ 在边 $AC$ 上，线段 $AD$ 与 $BE$ 交于点 $O$。若 $AO:OD=2:1$，$BO:OE=2:1$，$AE:EC=1:3$，求 $S_{OECD}:S_{\triangle OAB}$。
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{根据题干观察点的位置关系。}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$5:2$\par\medskip
    \solstep{统一份数}{设 $S_{\triangle OAE}=1$，则 $S_{\triangle OAB}=2$，$S_{\triangle OEC}=3$，$S_{\triangle OAC}=4$。由 $AO:OD=2:1$ 得 $S_{\triangle OCD}=2$，所以 $S_{OECD}=5$，目标比为 $5:2$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=8]
  ...
  \begin{minipage}[t]{\dimexpr\linewidth-60mm-6mm\relax}
    \vspace{0pt}
    在 $\triangle ABC$ 中，点 $D$ 在边 $BC$ 上，点 $E$ 在边 $AC$ 上，线段 $AD$ 与 $BE$ 交于点 $O$。若 $BO:OE=2:1$，$AE:EC=1:2$，且 $S_{OECD}:S_{\triangle OAB}=7:2$，求 $AO:OD$。
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{根据题干观察点的位置关系。}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$3:5$\par\medskip
    \solstep{反推}{设 $S_{\triangle OAE}=1$，则 $S_{\triangle OAB}=2$，$S_{\triangle OEC}=2$，$S_{\triangle OAC}=3$。目标比给出 $S_{OECD}=7$，故 $S_{\triangle OCD}=5$，所以 $AO:OD=3:5$。}
  \end{solutionblock}
\end{problem}
