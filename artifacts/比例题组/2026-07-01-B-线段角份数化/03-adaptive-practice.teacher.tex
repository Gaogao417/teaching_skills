...
\section*{线段和角份数化专题练习（教师版）}

\section*{一、交错训练：几何条件翻译成份数}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察整体 AC 由 AB 和 BC 组成。}
  \input{\detokenize{build/diagram/jobs/bq1-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$AB=10$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{比例已给出，$AC$ 为 $5$ 份，$1$ 份为 $5$，$AB=2$ 份为 $10$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察整体 AC 由 AB 和 BC 组成。}
  \input{\detokenize{build/diagram/jobs/bq2-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    ...
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$AB:BC=3:1$，总 $4$ 份，$BC=1$ 份为 $7$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察两个相邻角合成角 AOC。}
  \input{\detokenize{build/diagram/jobs/bq3-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$100^\circ$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{总 $5$ 份，每份 $25^\circ$，$\angle BOC=4$ 份为 $100^\circ$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察整体 AC 由 AB 和 BC 组成。}
  \input{\detokenize{build/diagram/jobs/bq4-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    ...
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$5AB=2BC$，所以 $AB:BC=2:5$，总 $7$ 份，每份 $3$，$AB=6$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察整体 AC 由 AB 和 BC 组成。}
  \input{\detokenize{build/diagram/jobs/bq5-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    ...
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$AB:BC=4:3$，总 $7$ 份，每份 $5$，$BC=15$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察两个相邻角合成角 AOC。}
  \input{\detokenize{build/diagram/jobs/bq6-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$42^\circ$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$4A=3B$，故 $A:B=3:4$，总 $7$ 份，每份 $14^\circ$，$A=42^\circ$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察整体 AC 由 AB 和 BC 组成。}
  \input{\detokenize{build/diagram/jobs/bq7-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$28$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$AB=5$ 份为 $20$，$1$ 份为 $4$，$AC=7$ 份为 $28$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察两个相邻角合成角 AOC。}
  \input{\detokenize{build/diagram/jobs/bq8-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$90^\circ$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$\angle AOB=3$ 份为 $54^\circ$，$1$ 份 $18^\circ$，整体 $5$ 份为 $90^\circ$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察整体 AC 由 AB 和 BC 组成。}
  \input{\detokenize{build/diagram/jobs/bq9-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$28$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$2AB=5BC$，$AB:BC=5:2$；$BC=2$ 份为 $8$，整体 $7$ 份为 $28$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察两个相邻角合成角 AOC。}
  \input{\detokenize{build/diagram/jobs/bq10-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$24^\circ$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$\angle AOB:\angle BOC=5:2$，总 $7$ 份，每份 $12^\circ$，$\angle BOC=24^\\ circ$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察整体 AC 由 AB 和 BC 组成。}
  \input{\detokenize{build/diagram/jobs/bq11-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$25$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$AB=3$ 份，$AC=8$ 份，则 $BC=5$ 份；$1$ 份为 $5$，$BC=25$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{观察两个相邻角合成角 AOC。}
  \input{\detokenize{build/diagram/jobs/bq12-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[28mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$30^\circ$\par\medskip
    \solstep{找整体}{先写出整体由两个部分组成。}
    \solstep{条件转份数}{$\angle AOC=7$ 份，$\angle AOB=2$ 份，则 $\angle BOC=5$ 份；$1$ 份 $15^\\ circ$，$\angle AOB=30^\circ$。}
  \end{solutionblock}
\end{problem}
