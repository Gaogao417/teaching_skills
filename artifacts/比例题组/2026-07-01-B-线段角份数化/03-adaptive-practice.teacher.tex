...
\end{tikzpicture}
  ...
  \begin{solutionblock}
    \textbf{答案：}$AB=14$\par\medskip
    \solstep{填法}{$AB:AC=2:7$，$\dfrac{AB}{49}=\dfrac{2}{7}$，$AB=14$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$BC=36$\par\medskip
    \solstep{填法}{$BC:AC=4:7$，$\dfrac{BC}{63}=\dfrac{4}{7}$，$BC=36$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$AB=12$\par\medskip
    \solstep{填法}{$AB:BC=2:7$，$\dfrac{AB}{54}=\dfrac{2}{9}$，$AB=12$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$BC=18$\par\medskip
    \solstep{填法}{$AB:BC=5:3$，$\dfrac{BC}{48}=\dfrac{3}{8}$，$BC=18$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$39^\circ$\par\medskip
    \solstep{填法}{$\angle AOB:\angle BOC=3:4$，$\dfrac{\angle AOB}{91^\circ}=\dfrac{3}{7}$，$\angle AOB=39^\circ$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$80^\circ$\par\medskip
    \solstep{填法}{$\angle AOB:\angle BOC=2:5$，$\dfrac{\angle BOC}{112^\circ}=\dfrac{5}{7}$，$\angle BOC=80^\circ$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$AB=32$\par\medskip
    \solstep{填法}{$AB:AC=4:9$，$\dfrac{AB}{72}=\dfrac{4}{9}$，$AB=32$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$BC=64$\par\medskip
    \solstep{填法}{$AB:BC=3:8$，$\dfrac{BC}{88}=\dfrac{8}{11}$，$BC=64$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$60^\circ$\par\medskip
    \solstep{填法}{$\dfrac{\angle AOB}{132^\circ}=\dfrac{5}{11}$，$\angle AOB=60^\circ$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$AB=45$\par\medskip
    \solstep{填法}{$AB:BC=5:6$，$\dfrac{AB}{99}=\dfrac{5}{11}$，$AB=45$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$BC=28$\par\medskip
    \solstep{填法}{$\dfrac{BC}{77}=\dfrac{4}{11}$，$BC=28$。}
  \end{solutionblock}
\end{problem}
...
\end{tikzpicture}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$77^\circ$\par\medskip
    \solstep{填法}{$\angle AOB:\angle BOC=4:7$，$\dfrac{\angle BOC}{121^\circ}=\dfrac{7}{11}$，$\angle BOC=77^\circ$。}
  \end{solutionblock}
\end{problem}
