...
\begin{problem}[points=4]
  ...
  \begin{solutionblock}
    ...
    \solstep{填法}{$4\to12$ 是 $\times3$，所以 $5\to15$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$21$\par\medskip
    \solstep{填法}{$6\to18$ 是 $\times3$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
    求 $5,20,3$ 的第四比例项 $x$：$5:20=3:x$，$x=\underline{\hspace{1.5cm}}$。
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$12$\par\medskip
    \solstep{填法}{$5\to20$ 是 $\times4$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
    求 $8,12,10$ 的第四比例项 $x$：$8:12=10:x$，$x=\underline{\hspace{1.5cm}}$。
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$15$\par\medskip
    \solstep{填法}{$8:12=2:3$，所以 $10:x=2:3$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$24$\par\medskip
    \solstep{填法}{$18$ 对应 $3$ 份，一份 $6$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$3x=35;\ x=\dfrac{35}{3}$\par\medskip
    \solstep{填法}{$7\cdot5=3x$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$4x=63;\ x=\dfrac{63}{4}$\par\medskip
    \solstep{填法}{$9\cdot7=4x$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$4(x+2)=15;\ x=\dfrac{7}{4}$\par\medskip
    \solstep{填法}{$x+2$ 要整体乘。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$9(2x-1)=30;\ x=\dfrac{13}{6}$\par\medskip
    \solstep{填法}{交叉后解一次方程。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
    正数 $x$ 是 $9$ 和 $16$ 的比例中项：$9:x=x:16$，$x=\underline{\hspace{1.5cm}}$。
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$12$\par\medskip
    \solstep{填法}{$x^2=144$，取正数。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
    正数 $x$ 是 $4$ 和 $25$ 的比例中项：$4:x=x:25$，$x=\underline{\hspace{1.5cm}}$。
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$10$\par\medskip
    \solstep{填法}{$x^2=100$，取正数。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=4]
    $\dfrac{x-3}{8}=\dfrac{5}{4}$，交叉相乘得 $\underline{\hspace{2.6cm}}$，$x=\underline{\hspace{1.5cm}}$。
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$4(x-3)=40;\ x=13$\par\medskip
    \solstep{填法}{$x-3$ 要整体乘。}
  \end{solutionblock}
\end{problem}
