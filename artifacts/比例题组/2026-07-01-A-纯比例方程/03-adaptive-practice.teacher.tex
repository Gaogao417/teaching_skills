...
\section*{纯比例方程专题练习（教师版）}

\section*{一、交错训练：先选方法再计算}
...
\begin{problem}[points=6]
  ...
  \begin{solutionblock}
    ...
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{倍数法：$4:12=5:x$，$4\to12$ 为 $\times3$，所以 $x=15$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \begin{solutionblock}
    ...
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{第四比例项：$5:15=4:x$，所以 $x=12$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
    $\dfrac{x}{24}=\dfrac{5}{8}$，求 $x$。
  \answerarea[24mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=15$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{份数法或倍数法：$24$ 对应 $8$ 份，$x$ 对应 $5$ 份，$x=15$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
    正数 $x$ 是 $4$ 和 $9$ 的比例中项，求 $x$。
  \answerarea[24mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=6$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{正比例中项：$4:x=x:9$，$x^2=36$，$x$ 为正数，所以 $x=6$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=20$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{交叉相乘：$2x=40$，$x=20$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
    $\dfrac{x+1}{6}=\dfrac{2}{3}$，求 $x$。
  \answerarea[24mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=3$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{交叉相乘：$3(x+1)=12$，$x=3$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \begin{solutionblock}
    \textbf{答案：}$x=12$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{第四比例项：$7:14=6:x$，$x=12$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
    正数 $x$ 是 $16$ 和 $25$ 的比例中项，求 $x$。
  \answerarea[24mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=20$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{正比例中项：$16:x=x:25$，$x^2=400$，$x=20$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=5$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{交叉相乘：$14x=70$，$x=5$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
    $\dfrac{2x-1}{5}=\dfrac{3}{4}$，求 $x$。
  \answerarea[24mm]
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=\dfrac{19}{8}$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{交叉相乘：$4(2x-1)=15$，$x=19/8$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$x=32$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{$12:x=3:8$，交叉得 $3x=96$，$x=32$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \begin{solutionblock}
    \textbf{答案：}$x=12$\par\medskip
    \solstep{方法选择}{先写比例式，判断是否能用倍数/份数法；不合适时交叉相乘。}
    \solstep{计算}{倍数法：$3\to18$ 为 $\times6$，所以 $2\to x$ 也为 $\times6$。}
  \end{solutionblock}
\end{problem}
