...
\begin{problem}[points=6]
  ...
  \begin{minipage}[t]{\dimexpr\linewidth-60mm-6mm\relax}
    \vspace{0pt}
    矩形甲的长为 $5$、宽为 $8$，矩形乙的长为 $10$、宽为 $16$。判断两个矩形是否相似。
  \end{minipage}\hfill
...
\begin{problem}[points=6]
  ...
  \begin{minipage}[t]{\dimexpr\linewidth-60mm-6mm\relax}
    \vspace{0pt}
    矩形甲的长为 $4$、宽为 $7$，矩形乙的长为 $8$、宽为 $12$。判断两个矩形是否相似。
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{矩形示意，边长以题干为准。}
...
\begin{problem}[points=6]
  ...
  \begin{minipage}[t]{\dimexpr\linewidth-60mm-6mm\relax}
    \vspace{0pt}
    矩形甲的两边长为 $\frac32$ 和 $\frac52$，矩形乙的两边长为 $3$ 和 $5$。判断两个矩形是否相似。
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{矩形示意，边长以题干为准。}
  ...
  \begin{solutionblock}
    \textbf{答案：}相似\par\medskip
    \solstep{比较长宽比}{$\frac32:\frac52=3:5$，乙也是 $3:5$，所以相似。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \begin{minipage}[t]{\dimexpr\linewidth-60mm-6mm\relax}
    \vspace{0pt}
    两个矩形相似。矩形甲的长为 $6$、宽为 $9$；矩形乙的长为 $10$、宽为 $x$。求 $x$。
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{矩形示意，边长以题干为准。}
...
\begin{problem}[points=6]
  ...
  \begin{minipage}[t]{\dimexpr\linewidth-60mm-6mm\relax}
    \vspace{0pt}
    两个矩形相似。矩形甲的长为 $8$、宽为 $12$；矩形乙的长为 $x$、宽为 $18$。求 $x$。
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{矩形示意，边长以题干为准。}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$12$\par\medskip
    \solstep{对应比例}{$8:12=x:18$，解得 $x=12$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \begin{solutionblock}
    ...
    \solstep{对应比例}{$(x+2):10=6:5$，得 $5(x+2)=60$，所以 $x=10$。}
  \end{solutionblock}
\end{problem}


\section*{第3组：未指定对应的多解}
...
\begin{problem}[points=6]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$25$ 或 $9$\par\medskip
    \solstep{分类}{若 $15$ 对应 $3$，则 $x=25$；若 $15$ 对应 $5$，则 $x=9$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$27$ 或 $\dfrac{16}{3}$\par\medskip
    \solstep{分类}{若 $12$ 对应 $4$，则 $x=27$；若 $12$ 对应 $9$，则 $x=\dfrac{16}{3}$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=6]
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}$49$ 或 $4$\par\medskip
    \solstep{分类}{若 $14$ 对应 $2$，则 $x=49$；若 $14$ 对应 $7$，则 $x=4$。}
  \end{solutionblock}
\end{problem}
