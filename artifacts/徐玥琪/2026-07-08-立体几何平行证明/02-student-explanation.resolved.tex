...
\end{minipage}\hfill
\begin{diagramcoltikz}{70mm}{正方体中观察 E、F 与底面边 AB 的平行关系。}
\input{\detokenize{build/diagram/jobs/explanation-ex1-prompt/rendered/prompt.fragment.tex}}
\end{diagramcoltikz}
\end{eduProblemBlock}
...
\begin{eduDualExplain}
  ...
  \begin{eduExplainRight}
    \eduColumnTitle{\eduIconBook}{解答}
      ...
      \begin{center}
        \begin{diagramcoltikz}{70mm}{连接 $EF$，它与底面内的 $AB$ 平行。}
        \input{\detokenize{build/diagram/jobs/explanation-ex1-solution/rendered/solution.fragment.tex}}
        \end{diagramcoltikz}
      \end{center}
...
\end{minipage}\hfill
\begin{diagramcoltikz}{70mm}{四棱锥中观察 AP 与平面 BDM，已知线面平行要推线线平行。}
\input{\detokenize{build/diagram/jobs/explanation-ex2-prompt/rendered/prompt.fragment.tex}}
\end{diagramcoltikz}
\end{eduProblemBlock}
...
\begin{eduDualExplain}
  ...
  \begin{eduExplainRight}
    \eduColumnTitle{\eduIconBook}{解答}
      ...
      \begin{center}
        \begin{diagramcoltikz}{70mm}{连 $MO$，$MO$ 是 $\triangle PAC$ 中位线，$MO\parallel AP$ 且在面 $BDM$ 内。}
        \input{\detokenize{build/diagram/jobs/explanation-ex2-solution/rendered/solution.fragment.tex}}
        \end{diagramcoltikz}
      \end{center}
...
\end{minipage}\hfill
\begin{diagramcoltikz}{70mm}{正方体上底面四个中点，先想哪两条相交线分别与另一面平行。}
\input{\detokenize{build/diagram/jobs/explanation-ex3-prompt/rendered/prompt.fragment.tex}}
\end{diagramcoltikz}
\end{eduProblemBlock}
...
\begin{eduDualExplain}
  ...
  \begin{eduExplainRight}
    \eduColumnTitle{\eduIconBook}{解答}
      ...
      \begin{center}
        \begin{diagramcoltikz}{70mm}{连 $MF$ 证 $AM\parallel DF$，同理 $AN\parallel BE$；$AM\cap AN=A$。}
        \input{\detokenize{build/diagram/jobs/explanation-ex3-solution/rendered/solution.fragment.tex}}
        \end{diagramcoltikz}
      \end{center}
...
\end{minipage}\hfill
\begin{diagramcoltikz}{70mm}{平行六面体四个中点，(1)(2)(3) 三问分别对应线线、线面、面面三层。}
\input{\detokenize{build/diagram/jobs/explanation-ex4-prompt/rendered/prompt.fragment.tex}}
\end{diagramcoltikz}
\end{eduProblemBlock}
...
\begin{eduDualExplain}
  ...
  \begin{eduExplainRight}
    \eduColumnTitle{\eduIconBook}{解答}
      ...
      \begin{center}
        \begin{diagramcoltikz}{70mm}{$MN$ 是 $\triangle BCD$ 中位线，$B_{1}D_{1}\parallel BD$，传递得 $MN\parallel B_{1}D_{1}$。}
        \input{\detokenize{build/diagram/jobs/explanation-ex4-p1/rendered/solution.fragment.tex}}
        \end{diagramcoltikz}
      \end{center}
  \end{eduExplainRight}
\end{eduDualExplain}
...
\begin{eduDualExplain}
  ...
  \begin{eduExplainRight}
    \eduColumnTitle{\eduIconBook}{解答}
      ...
      \begin{center}
        \begin{diagramcoltikz}{70mm}{取 $O$ 为 $A_{1}C_{1}$ 中点，$EO$ 中位线平行 $AC_{1}$，在面 $EB_{1}D_{1}$ 内。}
        \input{\detokenize{build/diagram/jobs/explanation-ex4-p2/rendered/solution.fragment.tex}}
        \end{diagramcoltikz}
      \end{center}
  \end{eduExplainRight}
\end{eduDualExplain}
