...
\end{enumerate}
\end{minipage}\hfill
\begin{diagramcoltikz}{70mm}{看清两面的交线 $m$ 与直线 $n$。}
\input{\detokenize{build/diagram/jobs/explanation-unit1-ex1-prompt/rendered/prompt.fragment.tex}}
\end{diagramcoltikz}
\end{eduProblemBlock}
...
\end{minipage}\hfill
\begin{diagramcoltikz}{70mm}{原题图：看清 $A$ 与中点 $P,Q$。}
\input{\detokenize{build/diagram/jobs/explanation-unit3-ex1-prompt/rendered/prompt.fragment.tex}}
\end{diagramcoltikz}
\end{eduProblemBlock}
...
连 $AP$ 并延长，与 $CB$ 的延长线交于 $M$（$M$ 落在底面 $ABCD$ 上），$M$ 即第二个公共点。
      ...
      \begin{center}
        \begin{diagramcoltikz}{70mm}{延长 $AP$ 找到底面上的 $M$，连线 $AM$ 即交线。}
        \input{\detokenize{build/diagram/jobs/explanation-unit3-ex1-solution-annotated/rendered/solution.fragment.tex}}
        \end{diagramcoltikz}
      \end{center}
...
\end{minipage}\hfill
\begin{diagramcoltikz}{70mm}{看清中点 $E,F$ 与 $C_1,D_1$。}
\input{\detokenize{build/diagram/jobs/explanation-unit4-ex1-prompt/rendered/prompt.fragment.tex}}
\end{diagramcoltikz}
\end{eduProblemBlock}
...
\begin{eduDualExplain}
  ...
  \begin{eduExplainRight}
    \eduColumnTitle{\eduIconBook}{解答}
      ...
      \begin{center}
        \begin{diagramcoltikz}{70mm}{连 $EF\parallel A_1B\parallel D_1C$，由推论③定面。}
        \input{\detokenize{build/diagram/jobs/explanation-unit4-ex1-solution-annotated/rendered/solution.fragment.tex}}
        \end{diagramcoltikz}
      \end{center}
    \vspace{1mm}
    {\color{edu-blue}\bfseries\small 一句话收束}\par\vspace{1mm}
