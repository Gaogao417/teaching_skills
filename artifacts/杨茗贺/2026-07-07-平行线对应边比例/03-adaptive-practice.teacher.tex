...
\textbf{提示：}要求的边是 $DE$，这条边的对应边是 $BC$；先想 $DE:AD=BC:AB$。\end{hintbox}
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 1 题图：观察对应边和已知长度。}
...
\textbf{提示：}要求的边是 $CE$，这条边的对应边是 $BD$；先把 $AB$ 和 $AC$ 的比例写出来。\end{hintbox}
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 2 题图：观察对应边和已知长度。}
...
\textbf{提示：}要求的边是 $BD$，这条边的对应边是 $CE$；先把 $AD$ 和 $AE$ 的比例写出来。\end{hintbox}
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 3 题图：观察对应边和已知长度。}
...
\begin{problem}[points=8]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 4 题图：观察对应边和已知长度。}
...
\begin{problem}[points=8]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 5 题图：观察对应边和已知长度。}
...
\begin{problem}[points=8]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 6 题图：观察对应边和已知长度。}
