...
\textbf{提示：}要求 $BC$，已知 $AC$，先想 $BC:AC$。\par 再把 $AC$ 改成总份数 $3+5$。\end{hintbox}
  ...
  \input{\detokenize{build/diagram/jobs/segment-teacher-q1-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
...
\textbf{提示：}先把 $4AB=7BC$ 改成线段比。\par 乘法式里，份数和系数是交叉对应的。\end{hintbox}
  ...
  \input{\detokenize{build/diagram/jobs/segment-teacher-q2-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
  \setcounter{solstep}{0}
...
\textbf{提示：}$BD$ 是从 $B$ 到 $D$，包含 $BC$ 和 $CD$。\par 把 $BD$ 的份数和 $AD$ 的总份数相比。\end{hintbox}
  ...
  \input{\detokenize{build/diagram/jobs/segment-teacher-q3-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[32mm]
  \setcounter{solstep}{0}
...
\begin{problem}[points=8]
  ...
  \input{\detokenize{build/diagram/jobs/segment-teacher-q4-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
  \setcounter{solstep}{0}
...
\begin{problem}[points=8]
  ...
  \input{\detokenize{build/diagram/jobs/segment-teacher-q5-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
  \setcounter{solstep}{0}
...
\begin{problem}[points=8]
  ...
  \input{\detokenize{build/diagram/jobs/segment-teacher-q6-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[34mm]
  \setcounter{solstep}{0}
