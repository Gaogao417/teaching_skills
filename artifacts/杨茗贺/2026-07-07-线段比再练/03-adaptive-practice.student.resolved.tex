...
\textbf{提示：}要求 $BC$，已知 $AC$，先想 $BC:AC$。\par 再把 $AC$ 改成总份数 $3+5$。\end{hintbox}
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 1 题图：先看点的顺序。}
  \input{\detokenize{build/diagram/jobs/segment-student-q1-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
\end{problem}
...
\textbf{提示：}先把 $4AB=7BC$ 改成线段比。\par 乘法式里，份数和系数是交叉对应的。\end{hintbox}
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 2 题图：先看点的顺序。}
  \input{\detokenize{build/diagram/jobs/segment-student-q2-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
\end{problem}
...
\textbf{提示：}$BD$ 是从 $B$ 到 $D$，包含 $BC$ 和 $CD$。\par 把 $BD$ 的份数和 $AD$ 的总份数相比。\end{hintbox}
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 3 题图：先看点的顺序。}
  \input{\detokenize{build/diagram/jobs/segment-student-q3-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[32mm]
\end{problem}
...
\begin{problem}[points=8]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 4 题图：先看点的顺序。}
  \input{\detokenize{build/diagram/jobs/segment-student-q4-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
\end{problem}
...
\begin{problem}[points=8]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 5 题图：先看点的顺序。}
  \input{\detokenize{build/diagram/jobs/segment-student-q5-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[30mm]
\end{problem}
...
\begin{problem}[points=8]
  ...
  \end{minipage}\hfill
  \begin{diagramcoltikz}{60mm}{第 6 题图：先看点的顺序。}
  \input{\detokenize{build/diagram/jobs/segment-student-q6-prompt/rendered/prompt.fragment.tex}}
  \end{diagramcoltikz}
  \par\medskip
  \answerarea[34mm]
\end{problem}
