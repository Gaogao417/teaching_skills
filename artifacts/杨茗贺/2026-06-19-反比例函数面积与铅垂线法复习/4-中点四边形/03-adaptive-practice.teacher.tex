...
\end{center}
  ...
  \begin{solutionblock}
    \textbf{答案：}（1）错误；（2）正确。\par\medskip
    \solstep{先反推对角线}{$E,F,G,H$ 是各边中点，所以 $EF\parallel AC$，$FG\parallel BD$。若 $EFGH$ 是矩形，则 $EF\perp FG$，因此 $AC\perp BD$。}
    \solstep{辨析条件}{只知道任意四边形的对角线垂直，不能推出它一定是菱形，所以（1）错误。若再知道 $ABCD$ 是平行四边形，平行四边形对角线互相垂直可推出它是菱形，所以（2）正确。}
  \end{solutionblock}
\end{problem}
...
\end{center}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}周长 $24$，面积 $18\sqrt3$。\par\medskip
    \solstep{反推原图形}{$EFGH$ 是矩形，所以 $AC\perp BD$。又 $ABCD$ 是平行四边形，因此 $ABCD$ 是菱形。}
    \solstep{求边长}{设菱形边长为 $a$。在 $\triangle ABC$ 中，$AB=BC=a$，$\angle ABC=120^\circ$，所以 $AC^2=a^2+a^2-2a^2\cos120^\circ=3a^2$。由 $AC=6\sqrt3$，得 $a=6$。}
    \solstep{求周长和面积}{周长为 $4a=24$。面积为 $a^2\sin120^\circ=36\cdot\frac{\sqrt3}{2}=18\sqrt3$。}
  \end{solutionblock}
\end{problem}
...
\end{center}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}周长 $28$，面积 $48$。\par\medskip
    \solstep{反推原图形}{$EFGH$ 是菱形，所以 $EF=FG$。又 $EF=\frac12 AC$，$FG=\frac12 BD$，所以 $AC=BD$。平行四边形对角线相等，因此 $ABCD$ 是矩形。}
    \solstep{求边长}{$EF=5$，所以 $AC=10$。矩形中 $AB=6$，故 $BC=\sqrt{10^2-6^2}=8$。}
    \solstep{求周长和面积}{周长为 $2(6+8)=28$，面积为 $6\times8=48$。}
  \end{solutionblock}
\end{problem}
...
\end{center}
  ...
  \setcounter{solstep}{0}
  \begin{solutionblock}
    \textbf{答案：}周长 $24$，面积 $36$。\par\medskip
    \solstep{反推原图形}{$EFGH$ 是正方形，所以 $AC=BD$ 且 $AC\perp BD$。平行四边形同时满足对角线相等和垂直，因此 $ABCD$ 是正方形。}
    \solstep{求边长}{$EF=\frac12 AC=3\sqrt2$，所以 $AC=6\sqrt2$。正方形边长为 $\frac{6\sqrt2}{\sqrt2}=6$。}
    \solstep{求周长和面积}{周长为 $24$，面积为 $36$。}
  \end{solutionblock}
\end{problem}
