...
\begin{problem}[points=8]
  ...
  \begin{solutionblock}
    ...
    \solstep{所用关系}{已知边属于全长，要求边属于长段，使用 $\text{长段}:\text{全长}=\dfrac{\sqrt5-1}{2}$。}
    \solstep{计算}{长段 $=20\times\dfrac{\sqrt5-1}{2}=10(\sqrt5-1)\text{ cm}$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=8]
  ...
  \begin{solutionblock}
    ...
    \solstep{所用关系}{已知边属于长段，要求边属于短段，使用 $\text{短段}:\text{长段}=\dfrac{\sqrt5-1}{2}$。}
    \solstep{计算}{短段 $=15\times\dfrac{\sqrt5-1}{2}=\dfrac{15(\sqrt5-1)}{2}\text{ cm}$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=8]
  ...
  \begin{solutionblock}
    ...
    \solstep{已知与所求}{已知边是较短静区 $6\text{ m}$，要求边是较长亮区。}
    \solstep{所用关系}{已知边属于短段，要求边属于长段，使用 $\text{短段}:\text{长段}=\dfrac{\sqrt5-1}{2}$。}
    \solstep{计算}{长段 $=6\div\dfrac{\sqrt5-1}{2}=\dfrac{12}{\sqrt5-1}=3(\sqrt5+1)\text{ m}$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=8]
  ...
  \begin{solutionblock}
    ...
    \solstep{所用关系}{已知边属于全长，要求边属于短段，先由全长求长段，再用全长减长段。}
    \solstep{计算}{长段 $=34\times\dfrac{\sqrt5-1}{2}=17(\sqrt5-1)\text{ m}$，短段 $=34-17(\sqrt5-1)=17(3-\sqrt5)\text{ m}$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=8]
  ...
  \begin{solutionblock}
    ...
    \solstep{所用关系}{已知边属于长段，要求边属于全长，使用 $\text{长段}:\text{全长}=\dfrac{\sqrt5-1}{2}$。}
    \solstep{计算}{全长 $=18\div\dfrac{\sqrt5-1}{2}=\dfrac{36}{\sqrt5-1}=9(\sqrt5+1)\text{ cm}$。}
  \end{solutionblock}
\end{problem}
...
\begin{problem}[points=8]
  ...
  \begin{solutionblock}
    ...
    \solstep{已知与所求}{已知边是较短窗格 $4\text{ m}$，要求边是整段窗格。}
    \solstep{所用关系}{已知边属于短段，要求边属于全长，先由短段求长段，再相加。}
    \solstep{计算}{长段 $=4\div\dfrac{\sqrt5-1}{2}=2(\sqrt5+1)\text{ m}$，全长 $=4+2(\sqrt5+1)=(6+2\sqrt5)\text{ m}$。}
  \end{solutionblock}
\end{problem}
...
第4题 $17(3-\sqrt5)\text{ m}$；第5题 $9(\sqrt5+1)\text{ cm}$；第6题 $(6+2\sqrt5)\text{ m}$。
