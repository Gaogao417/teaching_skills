...
在 Rt $ \triangle A B C $中，AC=BC，点D为AB中点， $ \angle G D H=9 0^{\circ} $ $ \angle G D H $绕点D旋转，DG， DH分别与AC，BC交于E，F两点.下列结论 $ \textcircled{1} $ $ A E+B F=\frac{\sqrt{2}}{2} A B $ $ \textcircled{2} $ $ A E^{2}+B F^{2}=E F^{2} $ $ \textcircled{3} $四边形CEDF的面积 $ S=\frac{1}{2} S_{\triangle A B C} $ $ \textcircled{4} $ $ \triangle D E F $始终为等腰直角三角形.其中正确的是 （ ）。

A. $ \textcircled{1} \textcircled{2} \textcircled{4} $ B. $ \textcircled{1} \textcircled{2} \textcircled{3} $ C. $ \textcircled{1} \textcircled{3} \textcircled{4} $ D. $ \textcircled{1} \textcircled{2} \textcircled{3} \textcircled{4} $

- 来源讲义：第9讲_几何综合（二）_教师版（敏学班）
- 来源定位：page=3；例题4
- 主题标签：动点与存在性、几何综合、综合题、OCR需复核
...
联结 CD ，证明 $ \triangle A D E\cong \triangle C D F $ A.S.A) ，可得 AE=CF ，DE=DF ， $ S_{\triangle A D E}=S_{\triangle C D F}
$ $ \textcircled{1} $ AE+BF=CF+BF=BC $ =\frac{\sqrt{2}}{2} $ AB，正确


![](page=4,bbox=[68, 34, 283, 103])


$ \textcircled{2} $ $ A E^{2}+B F^{2}=C F^{2}+C E^{2}=E F^{2} $ ，正确


$ \textcircled{3} $ $ S=S_{\triangle C F D}+S_{\triangle C D E}=S_{\triangle A D E}+S_{\triangle C D E}=S_{\triangle A
C D}=\frac{1}{2} S_{\triangle A B C} $ ，正确


$ \textcircled{4} $由 DE=DF得， $ \triangle DEF $为等腰三角形，正确，故选D
