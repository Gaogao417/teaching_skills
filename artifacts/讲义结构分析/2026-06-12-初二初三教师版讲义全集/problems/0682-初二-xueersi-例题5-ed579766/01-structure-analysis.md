# 结构分析：初二 xueersi 例题5：几何关系与辅助线/图形不变量

## 原题
【例题5】 ★★★☆☆☆

(1)已知 $ \triangle A B C\sim \triangle A^{\prime} B^{\prime} C^{\prime} $ ，A的对应点为 $ A^{\prime} $ ， $ A^{\prime} D^{\prime} $ 、AD分别是 $ \triangle A B C $和 $ \triangle A^{\prime} B^{\prime} C^{\prime} $的角平分线，且 $ \frac{A D}{A^{\prime} D^{\prime}}=\frac{4}{3} $ ，BC=16，则 $ B^{\prime} C^{\prime}= $ ___.

(2)已知 $ \triangle A B C $相似于 $ \triangle D E F $ ，A的对应点为D，B的对应点为E，C的对应点为F，且AC=3，DF=6，DE边上的中线为9，则AB边上的中线为___.

- 来源讲义：（数）2021年春八年级培优体系_教师版_第12讲_相似三角形（一）
- 来源定位：page=7；例题5
- 主题标签：几何综合、OCR需复核
...
【分析】 (1)根据相似三角形的性质， $ \frac{AD}{A^{\prime}D^{\prime}}=\frac{BC}{B^{\prime}C^{\prime}}\Rightarrow
\frac{4}{3}=\frac{16}{B^{\prime}C^{\prime}}\Rightarrow B^{\prime}C^{\prime}=12. $


(2) 对应点看仔细，


$ \frac{A C}{D F}=\frac{A B$边上的中线 $ D E $边上的中线 $ \Rightarrow \frac{3}{6}=\frac{A B$边上的中线 $ 9} {9} \Rightarrow A B
$边上的中线 $ =\frac{9}{2}. $


![](page=8,bbox=[69, 26, 284, 97])
