...
如图， $ \triangle ABC $中， $ \angle B=2\angle C $ ， $ AD\bot BC $于D，M为BC的中点， AB=10cm，求MD的长.
...
【分析】取AC中点N，联结MN、DN，因为点M、N分别是BC、AC的中点所以 MN//AB，且 $ M N=\frac{1}{2} A B=5 c m $ ；所以 $ \angle N M C=\angle B=2 \angle C $
，因为 AD $ \bot $ BC且N是AC的中点，所以 DN=CN $ =\frac{1}{2} A C $ ，所以 $ \angle N D M=\angle C $ ，所以 $ \angle M D N=\angle M N D
$ ，有：DM=MN=5cm
