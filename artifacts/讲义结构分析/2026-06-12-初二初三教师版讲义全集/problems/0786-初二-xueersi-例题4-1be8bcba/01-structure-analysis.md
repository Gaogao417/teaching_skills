...
- 来源讲义：（数）2021年春八年级培优体系_教师版_第6讲_一次函数与动点问题（敏学班）
- 来源定位：page=4；例题4
...
【分析】 (1)直线 BC的表达式为 y=4x-20；


(2) 当 CD//AB时，点 D在 x轴上，设 D(m,0)


$ \because A D=B C $ $ \therefore A D=\sqrt{m^{2}+4^{2}}=\sqrt{(6-5)^{2}+(4-0)^{2}} $ ，解得 m=士1,


经检验 $m =$ 土1是原方程的根，


但当 m=-1时，四边形ABCD是平行四边形，不合题意，舍去， $ \therefore D_{1}(1,0), $


当 AD//BC时，则直线 AD的函数解析式为 $ y=4 x+4 $
...
\therefore C D = \sqrt {(n - 5) ^ {2} + (4 n + 4) ^ {2}} = 6,

$$


解得 $ n_{1}=-\frac{5}{1 7} $ $ n_{2}=-1 $ ，经检验 $ n_{1}=-\frac{5}{1 7} $ $ n_{2}=-1 $ ，是原方程的根，当 $ n_{2}=-1
$时，四边形ABCD是平行四边形，不合题意，舍去，


$$

\therefore D _ {2} \left(- \frac {5}{1 7}, \frac {4 8}{1 7}\right),

$$


综上所述，点 D的坐标为（1，0）或 $ (-\frac{5}{17},\frac{48}{17}) $


![](page=5,bbox=[69, 27, 284, 96])
