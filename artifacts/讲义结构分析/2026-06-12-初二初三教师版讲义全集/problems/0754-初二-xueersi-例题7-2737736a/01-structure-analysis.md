# 结构分析：初二 xueersi 例题7：几何关系与辅助线/图形不变量

## 原题
【例题7】 ★★★★☆

已知：在 $ \triangle A B C $中，分别以AB、AC为斜边作等腰直角三角形ABM和CAN，P是边BC的中点.求证： $ P M=P N $

- 来源讲义：（数）2021年春八年级培优体系_教师版_第4讲_梯形综合（勤思班）
- 来源定位：page=6；例题7
- 主题标签：几何综合、综合题、OCR需复核
- OCR/图形状态：需人工复核：含图形条件，需对照原图；选择项/表格排版可能丢列；题目依赖图形，仅生成 diagram_request_packet，不生成图片。本结构分析只锁定 OCR 文本可见条件，不补造图中缺失条件。
...
【分析】取 AB中点 Q，AC中点 R，联结 PQ、PR、MQ、NR PQ//AC， $ P Q=\frac{1}{2} A C=N R $ PR//AB，PR=MQ， $ \angle P Q M=\angle P R N
\therefore \triangle P Q M\cong \triangle N R P $ PM=PN


![](page=7,bbox=[70, 28, 283, 95])


【悬赏1】如图，已知 $ \triangle A B D $和 $ \triangle A C E $都是直角三角形， $ \angle A B D=\angle A C E=9 0^{\circ} $ ，联结DE，设M为DE的中点.


(1) 求证： $ MB=MC $


(2) 设 $ \angle B A D=\angle C A E $ ，固定 Rt $ \triangle A B D $ ，让 Rt $ \triangle A C E $ 移至图示位置，此时 MB=MC 是否成立？请证明你的结论.


![](page=7,bbox=[315, 499, 884, 930])


![](page=7,bbox=[920, 494, 1506, 921])
...
【分析】 （1）如图所示，延长 BM交CE于N.因为 $ D M=E M $ ，CE//BD，故 $ \triangle D B M\cong \triangle E N M $


则 $ B M=N M $ ，从而 $ M C=\frac{1}{2} B N=M B. $


(2) 结论成立.


取 AD、AE 的中点 F、G，联结 FB、FM、MG、GC.


由 BF、CG是 Rt $ \triangle A B D $ 、Rt $ \triangle A C E $斜边上的中线可得 $ B F=\frac{1}{2} A D $ CG $ =\frac{1}{2} A E $


从而 MF=CG， MG=BF


又因为 $ \angle C G E=2 \angle C A E=2 \angle B A D=\angle B F D $ ， $ \angle M F D=\angle D A E=\angle M G E $故 $ \angle
B F M=\angle M G C $


从而 $ \Delta B F M\cong \Delta M G C $ ，故 MB=MC


![](page=7,bbox=[316, 1767, 884, 2210])


![](page=7,bbox=[926, 1765, 1506, 2205])


![](page=8,bbox=[69, 28, 284, 95])


## 本讲巩固


【巩固1】 (1)如图，在等腰梯形 ABCD中， AD // BC，对角线 BD=BC， AD=AB ，则 $ \angle A= $ ___.


![](page=8,bbox=[537, 511, 893, 784])


(2) 梯形 ABCD中， AD//BC， AD=AB， BC=BD， $ \angle A=1 0 0^{\circ} $ ，则 $ \angle C= $ ___.


【分析】 (1) $ 1 0 8^{\circ} $ (2) $ 7 0^{\circ} $
...
![](page=8,bbox=[1163, 1302, 1665, 1693])


【分析】联结 AC，作 EH $ \bot $ BD于 H，可证明 $ \angle E B D=3 0^{\circ} $


$ \therefore \angle D F E=\angle D E F=7 5^{\circ} $ ，从而 DE=DF


![](page=9,bbox=[69, 28, 284, 95])


【巩固3】如图，在等腰梯形ABCD中， $ \angle C=60^{\circ} $ $ AD//BC $ ，且 $ AD=DC $ ，E、F分别在AD、DC的延长线上，且 $ DE=CF $ ，AF、BE交于点P.


(1) 求证： AF=BE；


(2) 请你猜测 $ \angle B P F $的度数，并证明你的结论.


![](page=9,bbox=[538, 522, 1035, 850])


【分析】 (1) $ \because $ BA=AD， $ \angle B A E=\angle A D F $ ，AE=DF


$ \therefore \triangle B A E \cong \triangle A D F $ $ \therefore B E=A F $


(2) 猜测 $ \angle B P F=1 2 0^{\circ} $
...
$ \therefore \angle B P F=\angle A B E+\angle B A P=\angle B A E $ ，而 AD//BC， $ \angle B C D=\angle A B C=6 0^{\circ}
$


$$

\therefore \angle B P F = 1 2 0 ^ {\circ}

$$


【巩固4】 (1)等腰梯形的两底长为 4cm和10cm，一底角为 $ 4 5^{\circ} $ ，则它的面积为___.


(2)已知梯形的上底长为2，下底长为5，一腰长为4，另一腰长为 x ，则 x的取值范围是___.


(3) 如图，在梯形 ABCD中，AD//BC， $ \angle B+\angle C=9 0^{\circ} $ ，E、M、F、N分别为 AB、BC、CD、DA的中点，已知 $ B C=7 $ ，MN=3，则 EF的值为 ___.


![](page=9,bbox=[537, 1901, 1004, 2230])


【分析】 (1) $ 2 1 \mathrm{c m}^{2} $ ；(2) $ 1 < x < 7 $ ；(3)4.


![](page=10,bbox=[69, 28, 283, 95])


【巩固5】如图，已知四边形ABCD为等腰梯形，AD//BC，AB=CD， $ AD=\sqrt{2} $ ，E为 CD中点，联结AE，且 $ AE=2\sqrt{3} $ ， $ \angle DAE=30^{\circ} $ ，作AF
$ \bot $ AE交BC于F，求BF的长度.


![](page=10,bbox=[531, 515, 1025, 801])


![](page=10,bbox=[1068, 515, 1655, 798])


【分析】分别过 A、D作 AM $ \bot $ BC，AN $ \bot $ BC，延长AE、BC交于G


易证 $ \triangle A D E\cong \triangle G C E $ ， $ AG=AE+EG=4\sqrt{3} $


$$

\because \angle D A E = 3 0 ^ {\circ}, A F \bot A E

$$


$ \therefore \triangle AMG $ 、 $ \triangle AFM $和 $ \triangle AFG $是特殊的直角三角形（ $ 30^{\circ} $ 、 $ 60^{\circ} $ 、 $
90^{\circ} $ ）


$ \therefore F G=8 $ ， $ AF=4 $ ， $ FM=2 $


$$

\therefore M C = F G - M F - C G = 6 - \sqrt {2}
...
\therefore N C = M C - M N = 6 - 2 \sqrt {2}
...
\therefore B F = B M - M F = N C - M F = 4 - 2 \sqrt {2}
