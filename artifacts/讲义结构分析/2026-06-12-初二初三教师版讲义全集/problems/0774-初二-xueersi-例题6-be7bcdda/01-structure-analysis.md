# 结构分析：初二 xueersi 例题6：几何关系与辅助线/图形不变量
...
- 来源讲义：（数）2021年春八年级培优体系_教师版_第5讲_平面向量（敏学班）
- 来源定位：page=6；例题6
- 主题标签：几何综合、平面向量、OCR需复核
...
【分析】 (1) $ \vec{a}+\frac{1}{2}\vec{b} $ ； (2) $ \frac{1}{2}\vec{a}+\frac{1}{2}\vec{b} $ ； (3) $ 2\vec{a}+\vec{b} $


(4) $ - \vec{a}-\vec{b} $ ; $ \frac{2}{3}\vec{a}-\vec{b} $ . (5) $ \frac{1}{2}\vec{n}-\frac{1}{2}\overrightarrow{m} $
.
