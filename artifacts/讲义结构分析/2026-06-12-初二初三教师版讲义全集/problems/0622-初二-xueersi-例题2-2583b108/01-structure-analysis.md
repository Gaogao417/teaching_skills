...
A. $ \angle 1=\angle 4 $ B. $ \angle 1=\angle 3 $ C. $ \angle 2=\angle 3 $ D. $ OB^{2}+OC^{2}=BC^{2} $

(4)如图，在等腰梯形ABCD中，AD//BC，AC、BD相交于点O，则图中全等三角形共有（ ）
...
- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第4讲_梯形（勤思班）
- 来源定位：page=2；例题2
...
【分析】 (1) D；(2) C；(3) B；(4) C；(5) $ 6 0^{\circ} $；(6) 29.
