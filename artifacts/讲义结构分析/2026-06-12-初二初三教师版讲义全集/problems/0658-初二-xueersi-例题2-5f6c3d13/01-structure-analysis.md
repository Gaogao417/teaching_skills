...
【分析】 (1)对于直线 $ y=-\sqrt{3} x+2 \sqrt{3} $


$$

\therefore A (2, 0), \quad B (0, 2 \sqrt {3})
...
$ \textcircled{1} $当 AB是菱形的边时，


在菱形 $ A P_{1} Q_{1} B $中， $ Q_{1} O=A O=1 $ ，所以 $ Q_{1} $点的坐标为（-2，0），


在菱形 $ A B P_{2} Q_{2} $中， $ A Q_{2}=A B=4 $ ，所以 $ Q_{2} $点的坐标为（2，4），


在菱形 $ A B P_{3} Q_{3} $中， $ A Q_{3}=A B=2 $ ，所以 $ Q_{3} $点的坐标为（2,-4），


$ \textcircled{2} $当 AB为菱形的对角线时，


设菱形的边长为 x，则在 $ R t\triangle A P_{4} O $中， $ A P_{4}^{2}=A O^{2}+P_{4}O^{2} $即 $ x^{2}=2^{2}+(2-x)^{2} $解得 $
x=\frac{4\sqrt{3}}{3} $所以 $ Q_{4}\left(2,\frac{4\sqrt{3}}{3}\right). $
...
Q _ {1} (- 2, 0), Q _ {2} (2, 4), Q _ {3} (2, - 4), Q _ {4} \left(2, \frac {4 \sqrt {3}}{3}\right).

$$


![](page=4,bbox=[69, 27, 283, 96])
