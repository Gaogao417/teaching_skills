...
由题， $AD = DE = CE = CB$ ，设 $\angle ADE = x$ ， $\angle BCE = y$


则 $ \angle D A E=\angle D E A=\frac{1 8 0^{\circ}-x}{2}, $ $ \angle C E B=\angle C B E=\frac{1 8 0^{\circ}-y}{2}, $


又因为 $ x+y=1 8 0^{\circ}-4 5^{\circ} \times2=9 0^{\circ} $ $ \angle D E C=9 0^{\circ} $ ，故 $ \angle A E B=1 3 5^{\circ}
$
