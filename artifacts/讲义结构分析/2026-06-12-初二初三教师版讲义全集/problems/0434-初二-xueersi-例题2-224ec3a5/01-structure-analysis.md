...
- 来源讲义：第4讲_几何综合（三）_教师版（敏学班）
- 来源定位：page=2；例题2
- 主题标签：函数、几何综合、综合题、OCR需复核
...
若 $AB = AC$ ，则 $C\left(-3 - \sqrt{7},0\right)$ 或 $\left(-3 + \sqrt{7},0\right)$


若 $ AB=BC $ ，则C（1,0）


若 BC=AC，则 C $ \left(-\frac{5}{4},0\right) $
