...
(1) 如图，在 $ \triangle A B C $中，点 D为边 BC上一点，且 $ \frac{B D}{C D}=\frac{3}{2} $ ，点 E为 AD的中点，延长 BE交 AC于点 F，则 $ \frac{B E}{E F}= $

(2) 如图，点 D、E分别在 $ \triangle A B C $边 BC、AC上，连接线段 AD、BE交于点 F，若 AE：EC=1：3，BD：DC=2：3，则 EF：FB=___.

- 来源讲义：（数）2021年春八年级培优体系_教师版_第11讲_比例线段（二）
- 来源定位：page=6；例题4
- 主题标签：几何综合、OCR需复核
...
【分析】 （1）如图所示， $ \frac{BE}{EF}=4; $


![](page=6,bbox=[516, 1426, 912, 1727])


(2) 如图所示，EF：FB $ = \frac{3}{8} $


![](page=6,bbox=[521, 1860, 957, 2199])


![](page=7,bbox=[69, 27, 284, 96])
