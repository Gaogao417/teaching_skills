...
- 来源讲义：（数）2020年秋八年级培优体系_教师版_第15讲_期末复习（勤思班）
- 来源定位：page=4；例题5
...
A B ^ {2} - B H ^ {2} = A C ^ {2} - C H ^ {2}, \text {即} 5 ^ {2} - (4 - x) ^ {2} = \left(\sqrt {1 7}\right) ^ {2} - x
^ {2}

$$


化简整理得： $ 8 x=8,x=1 $ ，故 CH的长为1.


(2) 由(1)知 $ C H=1 $ ，故 $ B H=4-1=3. $


$$

\because A H ^ {2} = A B ^ {2} - B H ^ {2} = 5 ^ {2} - 3 ^ {2} = 1 6 \therefore A H = 4

$$


作 MD $ \bot $ AB，垂足为 D，则 $ \triangle B H M\cong \triangle B D M $


由勾股定理， $ M H^{2}+2^{2}=\left(4-M H\right)^{2} $解得 $ M H=\frac{3}{2}. $


$$

\because B P = x, \therefore C P = 4 - x, S _ {\Delta M P C} = \frac {1}{2} P C \cdot M H = \frac {1}{2} (4 - x)
\times \frac {3}{2}

$$


即 $ y=-\frac{3}{4} x+3, 0<x<4. $


(3) 当 $ \Delta MPC $为以MC为腰的等腰三角形时，若MP为腰， $ \because MH\bot PC $ $ \therefore PH=HC=1 $ ， $ BP=4-2=2. $


若 MP为底，PC=MC， $ \because MC=\sqrt{1^{2}+\left(\frac{3}{2}\right)^{2}}=\sqrt{\frac{13}{4}}=\frac{\sqrt{13}}{2}, $ $
\therefore BP=BC-PC=4-\frac{\sqrt{13}}{2} $ $ \therefore $当 $ \Delta MPC $为以MC为腰的等腰三角形时，BP的长为2或 $
4-\frac{\sqrt{13}}{2}. $


![](page=5,bbox=[43, 44, 257, 109])
