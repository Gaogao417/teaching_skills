# 结构分析：初二 xueersi 例题5：核心代数/几何结构识别
...
$ \textcircled{1} $ 2013年底的绿地面积为多少公顷？比2012年底增加了多少公顷？

$ \textcircled{2} $在2011年、2012年、2013年这三年中，增加绿地面积最多的是哪年？

$ \textcircled{3} $为满足城市发展的需要，计划在2014年底使城市绿地面积达到70.2公顷，试求2014年底绿地面积的增长率.

##

- 来源讲义：（数）2021年春八年级培优体系_教师版_第14讲_统计初步_z
- 来源定位：page=4；例题5
- 主题标签：动点与存在性、统计初步、应用建模
...
分析】 $ \textcircled{1} $ 2013年底的绿地面积为60公顷，比2012年底增加了 $ 6 0-5 6=4 $ （公顷）


$ \textcircled{2} $ 51-48=3（公顷），56-51=5（公顷），60-56=4（公顷）


$ \therefore $绿地面积增大最多的是2012年


$ \textcircled{3} $设2014年绿地面积年增长率为 x，得 $ 6 0 ( 1+x )=7 0. 2 $解得 x=17%


$ \therefore $2014年的绿地面积的年增长率为 17%
