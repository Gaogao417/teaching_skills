...
- 来源讲义：（数）2021年春八年级培优体系_教师版_第7讲_四边形中的动点问题三（敏学班）
- 来源定位：page=5；悬赏题
- 主题标签：函数、动点与存在性、几何综合、综合题、OCR需复核
...
(1) $\Delta PDE$ 为等腰直角三角形，理由如下：


易证 $ \triangle DHP\cong \triangle PGE $ ， $ \therefore \angle DPE=90^{\circ} $


$ \therefore \Delta P D E $为等腰直角三角形；


(2) 在 Rt $\Delta$ APH 中， $AP = x$


$$

\therefore A H = P H = \frac {\sqrt {2}}{2} x, \quad \therefore D H = 2 - \frac {\sqrt {2}}{2} x,

$$


$ \therefore $在 RtΔDPH中， $ PD^{2}=DH^{2}+PH^{2}=(\frac{\sqrt{2}}{2} x)^{2}+(2-\frac{\sqrt{2}}{2}
x)^{2}=x^{2}-2\sqrt{2} x+4, $


$ \because \Delta P D E $为等腰直角三角形，


$$

\therefore S _ {\Delta P D E} = \frac {1}{2} P D \times P E = \frac {1}{2} P D ^ {2} = \frac {1}{2} x ^ {2} - \sqrt
{2} x + 2 (0 < x, \sqrt {2})

$$


(3) 在等腰直角三角形 $ \Delta P D E $中， $ PD=PE $ $ \angle D P E=9 0^{\circ} $


$$

\therefore \angle P E D = \angle P D E = 4 5 ^ {\circ},

$$


当四边形 PBED 是梯形时，只有可能是四边形 PB//DE，


$$

\because C P = B C = 2, A P = 2 \sqrt {2} - 2, B G = G E = 2 - \sqrt {2}
...
\therefore C E = B C - (4 - 2 \sqrt {2}) = 2 \sqrt {2} - 2
...
\therefore P F = C P - C F = C P - C E = 4 - 2 \sqrt {2}.

$$


![](page=6,bbox=[44, 29, 257, 93])


## 本讲巩固


【巩固1】如图，射线 MB上， $ MB=9 $ ，A是射线 MB外一点， $ AB=5 $ ，且 A到射线 MB的距离 AC为3，动点 P从 M沿射线 MB方向以1个单位/秒的速度移动，设 P的运动时间为 t.求：


(1) $ \triangle P A B $为等腰三角形的 t 值；(2) $ \triangle P A B $为直角三角形的 t 值.


![](page=6,bbox=[530, 589, 1331, 846])


【分析】 (1)当 AP=AB时，PC=4，PB=8，PM=BM-PB=9-8=1，t=1秒；


当 BP=BA时，PB=5


若P在B的左侧， $ P M=B M-P B=9-5=4 $ ， $ t=4 $秒；


若 P在 B的右侧， $ P M=B M+P B=9+5=1 4 $ ， $ t=1 4 $秒；


当 PA = PB时，设 PA = PB = x，CP = BC - PB = 4 - x


在 $Rt\triangle ABC$ 中， $(4 - x)^{2} + 3^{2} = x^{2}$ ，解方程可得 $x = \frac{25}{8}$


$ P B=\frac{2 5}{8} $ $ P M=B M-P B=9-\frac{2 5}{8}=\frac{4 7}{8} $ $ t=\frac{4 7}{8} $秒；


![](page=6,bbox=[499, 1377, 1249, 1656])


(2) 当 $ \angle P=90^{\circ} $ ，P与C重合，PB=PC=4，PM=BM-PB=9-4=5，t=5秒；当 $ \angle A=90^{\circ} $ ，设PC=y，则PB=4+y，在Rt△APC中， $
AP^{2}=y^{2}+3^{2} $在Rt△APB中， $ \left(y^{2}+3^{2}\right)+5^{2}=\left(4+y\right)^{2} $ ，解得 $ y=\frac{9}{4} $ ， $
t=\frac{11}{4} $秒.


![](page=6,bbox=[489, 1913, 1575, 2150])
...
![](page=7,bbox=[43, 28, 259, 93])


【巩固2】如图，已知 $ \Box ABCD $中， $ AB=7cm $ ， $ BC=4cm $ ， $ \angle A=30^{\circ} $


(1) 点P从点A沿线段AB边向点B运动，速度为 $ 1 \mathrm{~cm} / \mathrm{s} $ . 若设运动时间为 t (s)连接PC，当t为何值时， $ \triangle P B C $为等腰三角形？


(2) 点 P从点 A沿射线 AB运动，速度仍是 1 cm/s . 当 t为何值时， $ \triangle P B C $为等腰三角形？


![](page=7,bbox=[674, 505, 1660, 755])


【分析】 (1) 若 $ \triangle P B C $为等腰三角形，则 $ B P=B C $ ，所以 7-t=4,t=3


(2) 四种情况：


如图1，当点P在线段AB上，BP=BC，则 t=3


如图2，当点P在AB延长线上，BP=BC，则AP=7+4=11，故 t=11


如图3，当 CP=CB，过C作CE $ \bot $ BP，则 BE= $ 2 \sqrt{3} $ ，则 AE=7+2 $ \sqrt{3} $ ，故 $ t=7+4\sqrt{3} $


如图4，当 PB=PC，过P作 PE $ \bot $ BC，则 BE=2，BP $ = \frac{4}{3}\sqrt{3} $所以 AP=7+ $ \frac{4}{3}\sqrt{3} $ t=7+ $
\frac{4}{3}\sqrt{3} $


![](page=7,bbox=[577, 1381, 1506, 1551])
...
![](page=7,bbox=[559, 1628, 1678, 1793])


![](page=8,bbox=[43, 28, 258, 93])


【巩固3】在 $ \triangle ABC $中， $ \angle C=90^{\circ} $ $ \angle B=30^{\circ} $ $ AC=6cm $
D、E分别是AC、AB的中点，联结DE，点P从点D出发，沿DE方向匀速运动，速度为1cm/s；同时，点Q从点B出发，沿BA方向匀速运动，速度为2cm/s，当点P停止运动时，点Q也停止运动。联结PQ，设运动时间为 t（ $
0<t<3\sqrt{3} $ ）.


(1) 当 t为何值时， $ P Q\bot A B? $


(2) 当Q在B、E之间运动时，使五边形PQBCD的面积为 $ y\mathrm{cm}^{2} $ ，求y与t之间的函数关系式.


![](page=8,bbox=[496, 603, 1077, 974])


【分析】 (1) 若 PQ $ \bot $ AB，则 $ \triangle P Q E $为直角三角形


当Q在线段BE上时， $ \angle PEQ=150^{\circ} $即 $ \triangle PQE $为钝角三角形


当Q在线段AE上时， $ \angle PEQ=30^{\circ} $ ，PQ $ \bot $ AB


在 Rt $ \Delta P Q E $中， $ Q E=2 t-6 $ ， $ P E=3 \sqrt{3}-t $


$$

\therefore t = \frac {8 4 - 2 1 \sqrt {3}}{1 3}
...
作 QH $ \bot $ DE交DE延长线于点H


在 Rt $ \triangle Q H E $中， $ Q E=6-2 t $


则 QH=3-t


又 $ \because P E=3 \sqrt{3}-t $


$$

\therefore S _ {\Delta P Q E} = \frac {1}{2} \times Q H \times P E = \fra
...
- 表层特征：函数、动点与存在性、几何综合、综合题、OCR需复核。
