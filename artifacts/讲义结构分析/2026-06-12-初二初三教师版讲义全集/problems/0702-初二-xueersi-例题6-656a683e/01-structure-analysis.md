...
如图，四边形ABCD是正方形，AC与BD相交于点O，点E、F是边AD上两动点，且 $ A E=D F $ ，BE与对角线AC交于点G，联结DG，DG交CF于点H.

(1) 求证： $ \angle A D G=\angle D C F $

(2) 联结HO，试证明HO平分 $ \angle CHG. $

- 来源讲义：（数）2021年春八年级培优体系_教师版_第15讲_期末复习z
- 来源定位：page=6；例题6
- 主题标签：动点与存在性、几何综合、证明与判定、综合题、OCR需复核
...
【分析】 (1)易证 $ \triangle A B E\cong \triangle C D F $ $ \triangle A B G\cong \triangle A D G $ ，所以 $ \angle A B G=\angle
A D G=\angle D C F $ (2)过O作OM $ \bot $ CF于M，作ON $ \bot $ DG于N，证明 $ \triangle C O M\cong \triangle D O N $
，所以OM=ON，所以HO平分 $ \angle C H G $
...
- 表层特征：动点与存在性、几何综合、证明与判定、综合题、OCR需复核。
