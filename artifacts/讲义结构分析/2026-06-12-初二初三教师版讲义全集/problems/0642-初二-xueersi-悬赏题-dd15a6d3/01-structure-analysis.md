...
如图，分别以 $ \triangle ABC $的边AC，BC为基准，在 $ \triangle ABC $外作正方形ACDE和CBFG，点P是EF的中点，求证：点P到边AB的距离是AB长度的一半.

- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第5讲_中位线及其应用（勤思班）
- 来源定位：page=7；悬赏题
...
【分析】分别过点E、F、C、P作AB的垂线，垂足依次为R、S、T、Q；


因为 $ E R\bot A B $ ，FS $ \bot A B $ ，CT $ \bot A B $ ，PQ $ \bot A B $ ；


所以 ER//FS//CT//PQ ；所以四边形 EFSR是平行四边形或梯形；


因为点P是EF的中点；所以 $ P Q=\frac{1}{2}\left( E R+F S\right) ; $


因为四边形ACDE和CBFG是正方形；所以EA=AC，FB=BC， $ \angle E A C=\angle F B C=9 0^{\circ} $所以 $ \angle E A R+\angle C A T=9 0^{\circ}
$ $ \angle F B S+\angle C B T=9 0^{\circ} $；
...
\angle A C T + \angle C A T = 9 0 ^ {\circ}, \angle B C T + \angle C B T = 9 0 ^ {\circ}

$$


所以 $ \angle E A R=\angle A C T $ $ \angle F B S=\angle B C T $


在 $ \triangle A E R $和 $ \triangle C A T $中， $ \left\{ \begin{array}{l l} \angle A R E = \angle C T A \\ \angle E A R
= \angle A C T; $所以 $ \triangle A E R\cong \triangle C A T $；所以 $ E R=A T $； $ E A=A C $


在 $ \triangle B F S $和 $ \triangle C B T $中， $ \left\{ \begin{array}{l l} \angle B S F = \angle C T B \\ \angle F B S
= \angle B C T; $所以 $ \triangle B F S \cong \triangle C B T $；所以FS=BT； $ F B=B C $


因为 $ A T+B T=A B=E R+F S $ ；所以 $ P Q=\frac{1}{2} A B. $
...
【巩固1】如图，D是 $ \triangle ABC $内一点， $ BD\bot CD $ $ AD=6 $ $ BD=4 $ $ CD=3 $ E、F、G、H分别是AB、 AC、CD、BD的中点，则四边形EFGH的周长是（   
）.
...
![](page=8,bbox=[371, 471, 640, 874])


【分析】 D


【巩固2】如图，已知 A为 DE的中点，设 $ \triangle D B C $ 、 $ \triangle A B C $ 、 $ \triangle E B C $的面积分别为 $ S_{1} $ 、 $ S_{2} $ 、 $
S_{3} $ ，则 $ S_{1} $ 、 $ S_{2} $ 、 $ S_{3} $之间的关系式是___.


![](page=8,bbox=[362, 1180, 831, 1453])


【分析】 $ S_{2}=\frac{1}{2} \left( S_{3}+S_{1} \right) $


【巩固3】 等腰梯形的周长为 80cm，高为12cm，中位线长与腰长相等，则它的面积为___ $ cm^{2} $
...
![](page=9,bbox=[69, 27, 285, 95])


【巩固4】如图，梯形 ABCD中， AB//DC， E是 AD的中点.


若 $ BC=AB+DC $ ，是否有 $ BE\bot CE? $


![](page=9,bbox=[451, 349, 1670, 767])


【分析】法一： $ \because E F=\frac{1}{2}\left( A B+D C\right) $ $ B C=A B+D C $ $ \therefore E F=\frac{1}{2} B C $ $
\because B F=C F=\frac{1}{2} B C $ $ \therefore BE\bot CE. $


$ \because E F//A B $ $ \therefore \angle A B E=\angle F E B $ $ \therefore \angle A B E=\angle C B E. $


法二：如图，延长BE、CD交于点F.解题过程与解析相似，不再给出.


【巩固5】点E、F、G分别是 $ \triangle ABC $三边的中点，AD $ \bot $ BD于点D，求证：四边形 DGEF是等腰梯形.


![](page=9,bbox=[402, 1064, 928, 1402])


【分析】可知： $ E G=F D=\frac{1}{2} A B $ ，EF//DG又 $ \because E G / / A B $ ，且FD与AB相交， $ \therefore F D $与EG不平行 $ \therefore
D G E F $是等腰梯形.


【巩固6】如图所示，D、E分别在 AB、AC上，BD=CE，BE、CD的中点分别是 M、N，直线 MN分别交 AB、AC于 P、Q.求证： AP=AQ.


![](page=9,bbox=[374, 1836, 1363, 2250])


【分析】取 BC中点 F，联结 FM、FN，则有 FM $ \cong \frac{1}{2} C E $ ，FN $ \cong \frac{1}{2} B D $


$ \therefore FM=FN\therefore \angle FMN=\angle FNM $


又 $ \because \angle APQ=\angle FNM,\angle AQP=\angle FMN $
