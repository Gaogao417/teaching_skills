...
在梯形ABCD中，AD//BC， $ \angle B=90^{\circ} $ $ \angle C=45^{\circ} $ $ AB=8 $ BC=14，点E、 F分别在边AB、CD上，EF//AD，点P与AD在直线EF的两侧， $ \angle EPF=90^{\circ} $ $ PE=PF $ ，射线EP、FP与边BC分别相交于点M、N，设AE=x，MN=y.
...
- 来源讲义：（数）2021年春八年级培优体系_教师版_第7讲_四边形中的动点问题三（勤思班）
- 来源定位：page=5；例题5
...
(2) BM=BE=8-x，CN=2BE=16-2x


$$

\therefore M N = B M + C N - B C = 1 0 - 3 x,

$$


$ \therefore y $关于 x的函数解析式为 $ y=-3 x+1 0 $．定义域为1， $ x<\frac{1 0}{3}. $


(3) 当点 P在梯形ABCD内部时，由 MN=2及(2)的结论得 $ 2=-3 x+1 0 $ ， $ A E=x=\frac{8}{3} $


$$

\therefore S _ {\text {梯形} A E F D} = \frac {1}{2} (A D + E F) \cdot A E = \frac {1}{2} \left(6 + 6 + \frac
{8}{3}\right) \times \frac {8}{3} = \frac {1 7 6}{9},

$$


当点 P在梯形ABCD外部时，由 MN=2及与（2）相同的方法得： $ \frac{1}{2} ( x+6 )-\frac{1}{2} \times2=8-x $
...
\therefore S _ {\text {梯形} A E F D} = \frac {1}{2} (A D + E F) \cdot A E = \frac {1}{2} (6 + 6 + 4) \times 4 = 3 2.

$$


![](page=6,bbox=[43, 29, 257, 93])
