...
- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第1讲_无理方程（勤思班）
- 来源定位：page=3；例题3
- 主题标签：方程与方程组、OCR需复核
...
】 (1)因为 $ \sqrt{2 x-1}-\sqrt{x-1}=\sqrt{6-x} $；


所以 $ \left( 2 x-1\right)-2\sqrt{2 x-1}\cdot \sqrt{x-1}+\left( x-1\right)=6-x, $


$ \sqrt{2 x-1}\cdot \sqrt{x-1}=2 x-4, $


$ 2 x^{2}-3 x+1=4 x^{2}-1 6 x+1 6, $


$ 2 x^{2}-1 3 x+1 5=0, \quad \left( x-5\right)\left( 2 x-3\right)=0, $


解得： x=5或 $ x=\frac{3}{2} $


经检验得 $ x=\frac{3}{2} $为增根，故原方程的根为 $ x=5 $


(2) 由题意得： $ x > \frac{19}{5} $


移项得 $ \sqrt{3x-3}-\sqrt{2x+8}=-\sqrt{5x-19} $


两边平方得 $ \sqrt{(3x-3)(2x+8)}=12 $


再两边平方整理得 $ x^{2}+3 x-2 8=0 $ ，所以 $ x_{1}=4,x_{2}=-7 $经检验得 $ x_{2}=-7 $为增根，故原方程的根为 $ x=4. $


![](page=4,bbox=[70, 28, 282, 95])
