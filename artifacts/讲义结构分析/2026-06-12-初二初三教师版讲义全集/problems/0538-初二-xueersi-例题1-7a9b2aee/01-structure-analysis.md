# 结构分析：初二 xueersi 例题1：一元二次方程判别式/根系关系
...
(2) $ \Delta=1 6-4 k\geq0, k\leq4 $ $ x_{1}-x_{2}=\frac{\sqrt{\Delta}}{\left|a\right|}=\frac{\sqrt{1 6-4 k}}{1}=7 $故
k=- $ \frac{3 3}{4} $


(3) a是方程 $ x^{2}-1 3 1 5 x+1=0 $的根，有 $ a^{2}-1 3 1 4 a=a-1 $有 $ a^{2}+1=1 3 1 5 a $又 $ a\neq0 $ $ \therefore a-1 3 1
5+\frac{1}{a}=0 $所以原式 $ =a-1+\frac{1}{a}=1 3 1 4 $
