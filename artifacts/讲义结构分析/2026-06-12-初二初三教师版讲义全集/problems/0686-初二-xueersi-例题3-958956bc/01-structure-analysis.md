...
如图，在 $ \Box ABCD $中，E是边AB的中点，F是边AD上一点， $ AF=\frac{1}{2}FD $，联结EF交AC于点G，若AC=10，则AG的长为___.
...
设 $ A E=a $ ，则 $ A B=C D=2 a $


$ \because A E / / D H $ $ \therefore \frac{A E}{D H}=\frac{A F}{F D} $即 $ D H=2 a $


又 $ \because A E / / C H $ $ \therefore \frac{A G}{C G}=\frac{A E}{C H} $即 $ \frac{A G}{G C}=\frac{1}{4}, $


$$

\therefore A G = \frac {1}{5} A C = 2.
