...
(1) 每件降低 x 元时，售价为 $ ( 6 0-x ) $元，


每件降低 x 元时，每星期销量为（ 300+10x ）件


(2) 由题意可得： $ \left( 6 0-x\right)\left( 3 0 0+1 0 x\right)=1 9 2 5 0 $


解得 $ x_{1}=25 $ ， $ x_{2}=5 $ ， $ \therefore $ 每件商品降低25元或5元时，销售额为19250
