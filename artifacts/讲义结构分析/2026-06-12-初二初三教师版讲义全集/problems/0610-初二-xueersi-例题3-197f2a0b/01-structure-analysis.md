# 结构分析：初二 xueersi 例题3：方程组结构变形

## 原题
【例题3】 ★★★☆☆

解方程组： $ \left\{ \begin{array}{l l} 4 x^{2}+4 x y+y^{2}+4 x+2 y-3=0 \\ y^{2}-x^{2}-5=0 \end{array} \right. $

- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第3讲_二元二次方程组（勤思班）
- 来源定位：page=2；例题3
- 主题标签：方程与方程组
...
【分析】 $ \left\{ \begin{array}{l l} {\left( 2 x+y\right)^{2}+2\left( 2 x+y\right)-3=0\textcircled{1}} \\
{y^{2}-x^{2}-5=0\textcircled{2}} \end{array} \right. $


由 $\textcircled{1}$ 得： $(2x + y + 3)(2x + y - 1) = 0$ ，


$ \therefore y=-2 x-3 $或 y=-2x+1,


分别代入 $ \textcircled{2} $解得：


$$

\left\{ \begin{array}{l l} x = 2 \\ y = - 3 \end{array} , \quad \left\{ \begin{array}{l l} x = - \frac {2}{3} \\ y =
\frac {7}{3} \end{array} , \quad \left\{ \begin{array}{l l} x = \frac {- 6 + 2 \sqrt {6}}{3} \\ y = \frac {3 - 4 \sqrt
{6}}{3} \end{array} , \quad \left\{ \begin{array}{l l} x = \frac {- 6 - 2 \sqrt {6}}{3} \\ y = \frac {3 + 4 \sqrt
{6}}{3} \end{array} \right. \right. \right.

$$


![](page=3,bbox=[70, 28, 283, 95])
