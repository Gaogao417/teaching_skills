# 结构分析：初二 xueersi 例题9：方程组结构变形

## 原题
【例题9】 ★★★★☆（换元型）

解方程： $ \frac{4 x}{x^{2}+x+3}+\frac{5 x}{x^{2}-5 x+3}=-\frac{3}{2}. $

- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第2讲_代数方程（勤思班）
- 来源定位：page=5；例题9
- 主题标签：方程与方程组、综合题
...
则原方程可化为 $ \frac{4x}{y+6x}+\frac{5x}{y}=-\frac{3}{2}, $


化简得： $ 2 0 x^{2}+1 2 x y+y^{2}=0 $


解得 $y = -2x$ 或 $y = -10x$ .


当 $ y=-2 x $时，即 $ x^{2}-5 x+3=-2 x $， $ x^{2}-3 x+3=0 $，方程无实数解；


当 $y = -10x$ 时，即 $x^{2} - 5x + 3 = -10x$ ， $x^{2} + 5x + 3 = 0$ ，解得 $x_{1,2} = \frac{-5\pm \sqrt{13}}{2}$ .
