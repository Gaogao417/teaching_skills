...
如图， $ \triangle A B C $中， $ \angle C A B $的平分线与BC的垂直平分线DG相交于D，过点D作DE $ \bot $AB，求证： $ B E=\frac{1}{2}\left( A B-A C\right) $

- 来源讲义：第3讲_中垂线综合_教师版（敏学班）
- 来源定位：page=3；例题6
...
过点D作DF $ \bot $ AC交AC延长线于F，联结CD、BD


先证 $ \triangle A D E\cong \triangle A D F $ ，所以 AE=AF，DE=DF，再证 $ \triangle D F C\cong \triangle D E B $ ，CF=BE


所以 $ A B - A C = B E + C F = 2 B E $ ，得证
