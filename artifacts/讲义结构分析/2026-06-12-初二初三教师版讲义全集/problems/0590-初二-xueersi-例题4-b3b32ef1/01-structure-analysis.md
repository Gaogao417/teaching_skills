...
- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第1讲_无理方程（敏学班）
- 来源定位：page=4；例题4
- 主题标签：方程与方程组
...
【分析】 (1)因为 $ \left\{\begin{array}{l l}x-\sqrt{1 0}\geq 0\\ \pi -x\geq 0\end{array}\right. $ ；所以 $
\left\{\begin{array}{l l}x\geq \sqrt{1 0}\\ x\leq \pi \end{array}\right. $ ；而 $ \pi < \sqrt{1 0} $ ，所以原方程无实数解.


(2) 因为 $\left\{ \begin{array}{l} 3 - x \geq 0 \\ \sqrt{x} = \sqrt{3 + \sqrt{3 - x}} \geq \sqrt{3} \end{array} \right.$
；所以 $\left\{ \begin{array}{l} x \leq 3 \\ x \geq 3 \end{array} \right.$ ， $x = 3$ ；
