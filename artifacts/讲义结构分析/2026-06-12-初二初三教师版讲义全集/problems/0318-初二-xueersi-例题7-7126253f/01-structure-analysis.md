# 结构分析：初二 xueersi 例题7：一元二次方程判别式/根系关系
...
由题意，得 $ 2 0 0 \times8 0-\left(2 0 0 x \times2+8 0 x \times3-x^{2} \times6\right)=1 5 3 6 6; $


解得 x=1或 $ x=\frac{317}{3} $ （大于 $ 8 0 \div2=4 0 $ ，舍去）；


答：小路的宽度最大不能超过1.0米.


![](page=6,bbox=[68, 35, 282, 104])
