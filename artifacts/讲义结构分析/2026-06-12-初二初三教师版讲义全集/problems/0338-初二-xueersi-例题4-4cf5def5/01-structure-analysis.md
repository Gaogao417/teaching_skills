...
(1) 由于乌鸦看到水瓶，沉思一会儿的过程中，水位不发生变化，可排除C选项；再由瓶中放入小石子，水位上升可知排除A选项；最后由乌鸦喝到水的水位一定大于瓶中开始的水位排除B选项，选D.


![](page=5,bbox=[68, 34, 283, 103])


(2) 如下图，在直径为AB的半圆O上有一动点P从A点出发，按顺时针方向绕半圆匀速运动到B点，然后再以相同的速度沿着直径回到A点停止，线段OP的长度d与运动时间t之间的函数关系用图像描述大致是（    ）


![](page=5,bbox=[312, 493, 794, 723])


![](page=5,bbox=[310, 761, 577, 1035])
...
![](page=5,bbox=[1009, 752, 1300, 1040])
...
![](page=5,bbox=[1351, 757, 1632, 1040])
...
(2) 点P在圆周上时，d不随t的变化而变化，故第一段图像平行x轴，点P在OB上，d随t的增加而减小，直到O，故此段图像呈下降趋势，点P在AO上，d随t的增加而增大，直到增加到半径的长度，即与第一段图像齐平，故选A.
