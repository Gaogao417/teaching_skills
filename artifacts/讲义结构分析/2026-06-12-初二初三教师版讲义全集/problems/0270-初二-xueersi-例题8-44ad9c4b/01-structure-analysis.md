...
(2) 过点D作DE $ \bot $ AB，垂足为E，


(3) 当 $ \triangle D P B $为等腰三角形


$ \textcircled{1} $ $ BP=BD=4-2\sqrt{2} $


$ \textcircled{2} $ $ PB=PD=2\sqrt{2}-2, $


$ \textcircled{3} $ DB=DP， BP=4 $ \sqrt{2}-4. $


![](page=6,bbox=[70, 34, 283, 103])
