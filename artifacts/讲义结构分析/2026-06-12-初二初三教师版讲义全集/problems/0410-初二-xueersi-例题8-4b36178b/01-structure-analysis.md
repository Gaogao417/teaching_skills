...
如图所示，在 $ \Delta A B C $中，AD平分 $ \angle B A C $， $ AD=AB $ ，CM $ \bot AD $于M，求证 $ AB+AC=2AM. $
...
取 PB 的中点 N，连接 MN，则 NM // BD，


故 $ \angle A N M=\angle A B D=\angle A D B=\angle A M N $ ，则 $ A M=A N $ .


容易证明 $ \Delta A P M\cong \Delta A C M $ ，故 $ AP=AC $
