...
若两个关于 x的方程 $ x^{2}+4 a x+4 a^{2}+a=0 $ $ x^{2}+\left( 2 a-1 \right) x+a^{2}=0 $中至少有一个方程有实数根，则求 a的取值范围.

- 来源讲义：第2讲_一元二次方程根的判别式_教师版（敏学班）
- 来源定位：page=4；例题8
- 主题标签：一元二次方程、综合题
...
方程 $ x^{2}+4 a x+4 a^{2}+a=0 $的 $ \Delta_{1}=\left(4 a\right)^{2}-4\times 1\times\left(4 a^{2}+a\right)=-4 a; $


方程 $ x^{2}+\left( 2 a-1\right) x+a^{2}=0 $的 $\Delta_{2}=\left( 2 a-1\right)^{2}-4\times 1\times a^{2}=-4 a+1; $


方法一：


若方程 $x^{2} + 4ax + 4a^{2} + a = 0$ 有实数根，则 $\Delta_1 = -4a\geq 0$ ， $a\leq 0$ ；


若方程 $x^{2} + (2a - 1)x + a^{2} = 0$ 有实数根，则 $\Delta_2 = -4a + 1\geq 0$ ， $a\leq \frac{1}{4}$ ；


综上所述，当 a $ \leq\frac{1}{4} $时，两个方程中至少有一个方程有实数根.


方法二：


若方程 $ x^{2}+4 a x+4 a^{2}+a=0 $没有实数根，


则 $\Delta_1 = \left(4a\right)^2 - 4\times 1\times \left(4a^2 + a\right) = -4a < 0$ ， $a > 0$ ；


若方程 $ x^{2}+\left( 2 a-1\right) x+a^{2}=0 $没有实数根，


则 $\Delta_2 = \left(2a - 1\right)^2 - 4\times 1\times a^2 = -4a + 1 < 0$ ， $a > \frac{1}{4}$ ；


综上所述，当 a > $ \frac{1}{4} $时，两个方程均没有实数根；


所以当 a $ \leq\frac{1}{4} $时，两个方程中至少有一个方程有实数根.
