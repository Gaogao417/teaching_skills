...
如图，正方形ABCD的边长为2，M是AD边的中点，动点P从点B出发，沿着 B-C-D-M的顺序运动。若点P经过的路程为x， $ \Delta B P M $的面积为y，求y与x的关系式.
...
当 P在 BC上时， $ y=\frac{1}{2}\times x\times 2=x $ （ 0 < x ≤2 ）


当 P在 CD上时， $ y=2\times 2-\frac{1}{2}\times 2\times 1-\frac{1}{2}\times 2\times(x-2)-\frac{1}{2}\times
1\times(4-x)=-\frac{1}{2}x+3 $ （ 2 < x ≤4 ）


当 P在 MD上时， $ y=\frac{1}{2}\times 2\times(5-x)=-x+5 $ （ 4<x<5 ）


$ \therefore y $与x的关系式为 $ y=\left\{ \begin{array}{l l} x ( 0 < x \leq 2 ) \\ -\frac{1}{2} x+3 ( 2 < x \leq 4 ) \\ -x+5
( 4 < x < 5 ) \end{array} \right. $


![](page=3,bbox=[53, 36, 264, 104])
