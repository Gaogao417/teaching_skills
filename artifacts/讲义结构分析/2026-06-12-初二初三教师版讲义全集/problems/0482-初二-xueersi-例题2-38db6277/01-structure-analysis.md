...
(1) 如图，正方形 ABCD的边长为 2cm，以 B为圆心，BC长为半径画弧交对角线 BD于点 E，连接 CE，P是 CE上任意一点，PM $ \bot $ BC于 M，PN $ \bot $ BD于 N，则 PM+PN的值为 ___.

- 来源讲义：（数）2020年秋八年级培优体系_教师版_第11讲_特殊的平行四边形（二）（勤思班）
- 来源定位：page=2；例题2
- 主题标签：几何综合、OCR需复核
...
作 CQ $ \bot $ BD于Q，则PM+PN=CQ，又CQ $ \cdot $ BD=BC $ \cdot $ CD，所以可知为 $ \sqrt{2} $ cm


(2) 如图，在边长为3的正方形 ABCD中两条对角线 AC、BD相交于点 O.点 P是边 AB上一点，过点 P分别作直线 AC、BD的垂线，垂足为 E、F，则 $ P E+P F= $ ___.


![](page=2,bbox=[307, 1555, 645, 1873])
