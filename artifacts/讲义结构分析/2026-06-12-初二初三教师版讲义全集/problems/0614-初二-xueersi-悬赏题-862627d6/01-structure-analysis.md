...
解方程组： $ \left\{ \begin{array}{l l} 2 x^{2}+4 x y-2 x-y+2=0 \\ 3 x^{2}+6 x y-x+3 y=0 \end{array} \right. $
...
【分析】 $ \textcircled{2} \times2-\textcircled{1} \times3 $得： $ 4 x+9 y-6=0. $


解方程组 $ \left\{ \begin{array}{l l} 4 x+9 y-6=0 \\ 3 x^{2}+6 x y-x+3 y=0 \end{array} \right. $得：
