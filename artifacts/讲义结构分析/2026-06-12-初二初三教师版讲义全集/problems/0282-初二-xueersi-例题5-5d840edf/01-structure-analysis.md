...
计算：(1) $ \frac{1}{1+\sqrt{2}}+\frac{1}{\sqrt{2}+\sqrt{3}}+\frac{1}{\sqrt{3}+\sqrt{4}}+\cdots+\frac{1}{\sqrt{2017}+\sqrt{2018}} $

(2) $ \frac{1}{1+\sqrt{3}}+\frac{1}{\sqrt{3}+\sqrt{5}}+\frac{1}{\sqrt{5}+\sqrt{7}}+\cdots+\frac{1}{\sqrt{2015}+\sqrt{2017}} $

- 来源讲义：第1讲_二次根式综合_教师版_（敏学班）
- 来源定位：page=3；例题5
- 主题标签：二次根式、综合题
...
(1) 原式 $ = (\sqrt{2}-1)+(\sqrt{3}-\sqrt{2})+\cdots+(\sqrt{2018}-\sqrt{2017})=\sqrt{2018}-1 $


(2) 原式 $ = \frac{1}{2}\left[(\sqrt{3} - 1) + (\sqrt{5} - \sqrt{3}) + \dots + (\sqrt{2017} - \sqrt{2015})\right] =
\frac{\sqrt{2017} - 1}{2} $
