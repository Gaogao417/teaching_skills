...
(2) 当点 P在线段CB上时，设 $ B E= x $ ， $ \Delta A C P $的面积为 y，求 y关于 x的函数解析式，并写出函数的定义域；

(3) 如果 $BE = 2$ ，请直接写出 $\Delta ACP$ 的面积.

- 来源讲义：（数）2020年秋八年级培优体系_教师版_第13讲_函数的动点问题（勤思班）
- 来源定位：page=6；例题5
- 主题标签：函数、动点与存在性、OCR需复核
...
(1) 在 $ \Delta A B C $中， $ \because A C=2 \sqrt{3} $ $ B C=4 \sqrt{3} $ $ A B=6 $ $ \therefore A C^{2}+A B^{2}=4 8 $ $
B C^{2}=4 8 $ $ \therefore A C^{2}+A B^{2}=B C^{2} $ $ \therefore \angle B A C=9 0^{\circ}. $


又 $ \because A C=2 \sqrt{3} $ $ B C=4 \sqrt{3} $ $ \therefore A C=\frac{1}{2} B C $ $ \therefore \angle B=30^{\circ}.
$


(2) 过点A作 $ AD\bot BC $ ，垂足为点D.


在 $\Delta ADB$ 中， $ \because \angle ADB=90^{\circ} $ $ \angle B=30^{\circ} $ $ \therefore AD=\frac{1}{2} AB=3 $


同理， $ EF=\frac{1}{2} BE=\frac{1}{2} x. $


在 Rt $ \Delta E F B $中， $ E F^{2}+F B^{2}=E B^{2} $即 $ (\frac{1}{2} x)^{2}+B F^{2}=x^{2} $ $ \therefore B
F=\frac{\sqrt{3}}{2} x $


又 $ \because BP=2BF $ $ \therefore BP=\sqrt{3} x $ $ \therefore CP=CB-PB=4\sqrt{3}-\sqrt{3} x $


$$

\because S _ {\Delta A C P} = \frac {1}{2} C P \square A D, \therefore y = \frac {1}{2} \left(4 \sqrt {3} - \sqrt {3}
x\right) \times 3 = 6 \sqrt {3} - \frac {3 \sqrt {3}}{2} x, (0 < x \leq 4);

$$


(3) 当点P在线段BC上时，由 $ BE=2 $知 $ x=2 $


由（2）知此时 $ \Delta A C P $的面积为 $ 6\sqrt{3}-\frac{3\sqrt{3}}{2}\times2=3\sqrt{3} $；


当点 $P$ 在射线CB上时， $EF = \frac{1}{2} BE = 1$ ，则 $PF = BF = \sqrt{3}$


$ \because A B=6 $ $ \therefore A M=\frac{1}{2} A B=3 $


则 $\Delta ACP$ 的面积为 $\frac{1}{2} \times PC \times AM = \frac{1}{2} \times (4\sqrt{3} + \sqrt{3} + \sqrt{3}) \times 3 =
9\sqrt{3}$ .


![](page=7,bbox=[53, 36, 264, 104])
