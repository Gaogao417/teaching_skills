# 结构分析：初二 xueersi 例题6：方程组结构变形

## 原题
【例题6】★★★★☆

(1)解方程组： $ \left\{\begin{array}{l} \frac{x(y+1)}{x+y+1}=\frac{6}{5} \\ \frac{x(z+2)}{x+z+2}=\frac{12}{7} \\ \frac{(y+1)(z+2)}{y+z+3}=\frac{4}{3} \end{array} \right. $
...
【分析】分子分母颠倒 $ \left\{\begin{array}{l} \frac{x+y+1}{x(y+1)}=\frac{5}{6} \\ \frac{x+z+2}{x(z+2)}=\frac{7}{12} \\
\frac{y+z+3}{(y+1)(z+2)}=\frac{3}{4} \end{array} \right. $即 $ \left\{\begin{array}{l}
\frac{1}{x}+\frac{1}{y+1}=\frac{5}{6} \\ \frac{1}{z+2}+\frac{1}{x}=\frac{7}{12} \\
\frac{1}{y+1}+\frac{1}{z+2}=\frac{3}{4} \end{array} \right. $


将其看为关于 $ \frac{1}{x} $ 、 $ \frac{1}{y+1} $ 、 $ \frac{1}{z+2} $方程组.


![](page=4,bbox=[33, 90, 245, 161])


解得： $ \left\{\begin{array}{l l} {\frac{1}{x}=\frac{1}{3}} \\ {\frac{1}{y+1}=\frac{1}{2}} \\
{\frac{1}{z+2}=\frac{1}{4}} \end{array} \right. $ ，所以 $ \left\{\begin{array}{l l} {x=3} \\ {y=1} \\ {z=2} \end{array}
\right. $


经检验 $ \left\{\begin{array}{l l} {x=3} \\ {y=1} \\ {z=2} \end{array} \right. $为原方程组的解.


原方程组的解为： $ \left\{\begin{array}{l l} {x=3} \\ {y=1} \\ {z=2} \end{array} \right. $


(2)解方程组： $ \left\{\begin{array}{l l} {x+y=xy} \\ {y+z=2yz} \\ {z+x=5zx} \end{array} \right. $


【分析】 原方程组的解为： $ \left\{\begin{array}{l l} {x=0} \\ {y=0} \\ {z=0} \end{array} \right. $或 $ \left\{\begin{array}{l l}
{x=\frac{1}{2}} \\ {y=-1} \\ {z=\frac{1}{3}} \end{array} \right. $ （同除 xy、yz、zx，化为分式方程组）或者可以代入消元，强行死算！
