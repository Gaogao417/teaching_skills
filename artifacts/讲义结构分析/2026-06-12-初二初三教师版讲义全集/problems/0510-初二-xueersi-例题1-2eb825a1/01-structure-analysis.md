...
y = \frac {1}{2} \times x \times 2 = x (0 < x \leq 2)
...
y = 2 \times 2 - \frac {1}{2} \times 2 \times 1 - \frac {1}{2} \times 2 \times (x - 2) - \frac {1}{2} \times 1 \times
(4 - x) = - \frac {1}{2} x + 3 (2 < x \leq 4)
...
y = \frac {1}{2} \times 2 \times (5 - x) = - x + 5 (4 < x < 5)
