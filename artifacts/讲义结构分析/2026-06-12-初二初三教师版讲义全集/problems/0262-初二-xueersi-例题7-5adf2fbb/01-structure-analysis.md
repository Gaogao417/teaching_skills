...
如图，等边 $ \triangle OAB $和等边 $ \triangle AFE $的一边都在 x轴上，反比例函数 $ y=\frac{k}{x} ( k > 0 ) $的图像经过边 OB的中点C和AE的中点D．已知等边 $ \triangle OAB $的边长为8，
...
(1) 点 C的坐标是 $ \left( 2,2\sqrt{3} \right) $
