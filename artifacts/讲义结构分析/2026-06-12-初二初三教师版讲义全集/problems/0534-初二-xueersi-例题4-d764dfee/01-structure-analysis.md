...
- 来源讲义：（数）2020年秋八年级培优体系_教师版_第14讲_三角形中的动点问题（敏学班）
- 来源定位：page=4；例题4
- 主题标签：函数、动点与存在性、几何综合
...
由勾股定理得， $ AB^{2}=(5+1)^{2}+4^{2}, $ $ AP^{2}=1^{2}+y^{2}, $ $ BP^{2}=5^{2}+(4-y)^{2}, $


$$

\because \angle P = 9 0 ^ {\circ}

$$


$ \therefore A B^{2}=A P^{2}+B P^{2} $即 $ (5+1)^{2}+4^{2}=1^{2}+y^{2}+5^{2}+(4-y)^{2}, $


$ \therefore $当点 P的坐标为（0,5）或 P(0,-1)时， $ \Delta A B P $是以 $ \angle P $为直角的直角三角形.


![](page=5,bbox=[69, 44, 284, 110])
