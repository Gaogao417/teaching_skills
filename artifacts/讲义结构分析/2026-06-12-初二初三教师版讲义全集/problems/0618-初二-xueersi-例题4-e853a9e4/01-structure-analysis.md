...
解方程组： $ \left\{ \begin{array}{l l} x^{2}+4 x y+4 y^{2}=9 \\ x^{2}+x y=0 \end{array} \right. $

- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第3讲_二元二次方程组（敏学班）
- 来源定位：page=2；例题4
- 主题标签：方程与方程组
...
【分析】 $ \left\{\begin{array}{l l}x_{1}=0\\ y_{1}=1.5\end{array}\right.,\left\{\begin{array}{l l}x_{2}=-3\\
y_{2}=3\end{array}\right.,\left\{\begin{array}{l l}x_{3}=0\\ y_{3}=-1.5\end{array}\right.,\left\{\begin{array}{l
l}x_{4}=3\\ y_{4}=-3\end{array}\right. $


![](page=3,bbox=[70, 27, 283, 95])
