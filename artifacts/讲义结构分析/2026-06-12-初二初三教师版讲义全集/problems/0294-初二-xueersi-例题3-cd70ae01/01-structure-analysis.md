...
由题意得，可列 $\left\{ \begin{array}{l} \Delta_1 = (7 - m)^2 - 4(n + 3) > 0 \\ \Delta_2 = (4 + m)^2 - 4(n + 6) = 0 \\
\Delta_3 = (m - 4)^2 - 4(n + 1) < 0 \end{array} \right.$，解得： $\frac{5}{4} < m < \frac{45}{22}$


又因为 m、n是整数，所以， $ m=2 $ ， $ n=3. $
