...
联结 CD ，证明 $ \triangle A D E\cong \triangle C D F \left( A. S. A \right) $ ，可得 $ A E=C F $ ， $ D E=D F $ ， $
S_{\triangle A D E}=S_{\triangle C D F} $


$ \textcircled{1} $ $ A E+B F=C F+B F=B C=\frac{\sqrt{2}}{2} A B $ ，正确
