...
- 来源讲义：（数）2020年_寒_八年级_培优体系_教师版_第2讲_代数方程（敏学班）
- 来源定位：page=2；例题3
- 主题标签：方程与方程组
...
【分析】 （1）分组分解： $ \left(x-1\right)\left(x^{2}+1\right)=0 $ ， $ x=1 $ ；


(2) 分组分解： $ x^{2}\left(3x-2\right)+3\left(3x-2\right)=0,\left(x^{2}+3\right)\left(3x-2\right)=0,x=\frac{2}{3} $
