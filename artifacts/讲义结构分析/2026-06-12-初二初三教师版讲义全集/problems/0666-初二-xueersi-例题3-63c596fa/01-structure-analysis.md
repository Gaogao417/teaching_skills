# 结构分析：初二 xueersi 例题3：几何关系与辅助线/图形不变量

## 原题
【例题3】 ★★★☆☆☆

(1) 若设 $ \frac{a}{b}=\frac{c}{d}=\frac{e}{f}=\frac{1}{4} $ ，且 $ b+d-f\neq0 $ ，则 $ \frac{a+c-e}{b+d-f}= $ ___.

【A】(2)已知 $ \frac{a}{5}=\frac{b}{7}=\frac{c}{8}, $ $ a+b+c=20 $ ，则 $ 2a+b-c= $ ___.

【A+】(3)若 $ \frac{a+b-c}{c}=\frac{a-b+c}{b}=\frac{-a+b+c}{a} $ ，则 $ \frac{(a+b)(a+c)(b+c)}{abc}= $ ___.
...
【分析】 (1)由 $ \frac{a}{b}=\frac{c}{d}=\frac{e}{f}=\frac{1}{4} $得 $ \frac{a}{b}=\frac{c}{d}=\frac{-e}{-f}=\frac{1}{4} $
，因为 $ b+d-f\neq0 $ ，所以 $ \frac{a+c-e}{b+d-f}=\frac{1}{4} $


(2) 因为 $ 5+7+8\neq0 $所以 $ \frac{a}{5}=\frac{b}{7}=\frac{c}{8}=\frac{a+b+c}{5+7+8}=\frac{20}{20}=1 $所以 a=5，b=7， $ c=8 $
，则 2a+b-c=9


(3) $ \textcircled{1} $若 a+b+c≠0，由等比性质得


$$

\frac {a + b - c}{c} = \frac {a - b + c}{b} = \frac {- a + b + c}{a} = \frac {\left(a + b - c\right) + \left(a - b +
c\right) + \left(- a + b + c\right)}{a + b + c} = 1

$$


![](page=3,bbox=[69, 28, 283, 95])


$$

\therefore a + b - c = c, a - b + c = b, - a + b + c = a

$$


于是有 $ \frac{(a+b)(a+c)(b+c)}{abc}=\frac{2c\cdot 2b\cdot 2a}{abc}=8 $


$ \textcircled{2} $若 a+b+c=0， $ \therefore a+b=-c $ $ \therefore b+c=-a $ $ c+a=-b $


于是有 $ \frac{(a+b)(a+c)(b+c)}{abc}=\frac{(-c)(-b)(-a)}{abc}=-1 $ . 综上原式的值为8或-1.
