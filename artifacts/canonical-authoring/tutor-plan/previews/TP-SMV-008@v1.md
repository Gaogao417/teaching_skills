...
- 提示 L1：先别急着算——这一步的关键是「平行出 8 字相似」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「平行出 8 字相似」。
...
- 提示 L1：先别急着算——这一步的关键是「写向量中间式」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「写向量中间式」。
...
- 提示 L1：先别急着算——这一步的关键是「代入定比收尾」。说说你打算怎么找？
- 提示 L2：常见卡点是「两个系数的比分母用反」。回到「代入定比收尾」，检查还有哪个已知条件没有用上。
...
- 提示 L1：先别急着算——这一步的关键是「数据准备」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「数据准备」。
...
- 提示 L1：先别急着算——这一步的关键是「构矩形转移」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「构矩形转移」。
...
- 提示 L1：先别急着算——这一步的关键是「直角三角形求正弦」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「直角三角形求正弦」。
