...
- 提示 L1：先别急着算——这一步的关键是「等积式改比例」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「等积式改比例」。
...
- 提示 L1：先别急着算——这一步的关键是「配 SAS 相似」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「配 SAS 相似」。
...
- 提示 L1：先别急着算——这一步的关键是「导角收尾证垂直」。说说你打算怎么找？
- 提示 L2：常见卡点是「导角链跳步，直接宣布垂直」。回到「导角收尾证垂直」，检查还有哪个已知条件没有用上。
...
- 提示 L1：先别急着算——这一步的关键是「目标改写为比例」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「目标改写为比例」。
...
- 提示 L1：先别急着算——这一步的关键是「锁定两组相似」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「锁定两组相似」。
...
- 提示 L1：先别急着算——这一步的关键是「比例相乘约分收尾」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「比例相乘约分收尾」。
