...
- 提示 L1：先别急着算——这一步的关键是「读题标注，等角翻译成等边」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「读题标注，等角翻译成等边」。
...
- 提示 L1：先别急着算——这一步的关键是「抓翻折不变量，识别母子型结构」。说说你打算怎么找？
- 提示 L2：提示：先写出这一步要用到的已知条件，再看它们如何组合出「抓翻折不变量，识别母子型结构」。
...
- 提示 L1：先别急着算——这一步的关键是「设元列式求 BE」。说说你打算怎么找？
- 提示 L2：常见卡点是「在斜三角形中硬凑勾股」。回到「设元列式求 BE」，检查还有哪个已知条件没有用上。
